# Release 071 — Connector Marketplace Governance

## Objective

Govern connector discovery, approval, capability scopes, publisher identity, egress allowlists, versioning and revocation.

## Delivered architecture

- Tenant-scoped `marketplace-connectors` contract.
...
- `write_capabilities_need_approval`
- `revoked_connector_denied`
