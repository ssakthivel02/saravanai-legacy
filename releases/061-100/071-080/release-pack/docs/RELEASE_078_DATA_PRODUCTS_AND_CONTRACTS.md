# Release 078 — Data Products and Contracts

## Objective

Create discoverable data products with owners, schemas, quality objectives, consumers, versions and deprecation plans.

## Delivered architecture

- Tenant-scoped `data-products` contract.
