# Release 072 — Business Process Orchestration

## Objective

Model tenant-safe business processes as versioned DAGs with approvals, retries, compensation and idempotency.

## Delivered architecture

- Tenant-scoped `business-processes` contract.
...
- `idempotency_required_for_writes`
- `approval_required_for_high_impact`
