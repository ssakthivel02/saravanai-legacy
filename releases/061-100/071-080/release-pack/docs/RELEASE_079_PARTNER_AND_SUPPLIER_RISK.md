# Release 079 — Partner and Supplier Risk

## Objective

Assess suppliers, subprocessors and partners for security, privacy, resilience, financial and concentration risk.

## Delivered architecture

- Tenant-scoped `supplier-assessments` contract.
...
- `supplier_required`
- `score_range`
- `critical_supplier_due_diligence`
- `high_findings_block_approval`
- `conditional_decision_requires_treatment_plan`
