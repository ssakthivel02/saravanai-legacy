# Release 096 — Capacity and Performance Engineering

## Objective

Define service capacity, headroom, latency, throughput and saturation thresholds with privacy-safe load tests.

## Delivered architecture

- Tenant-scoped `capacity-profiles` contract.
...
- `maximum_above_expected`
- `headroom_range`
- `latency_target_positive`
- `saturation_range`
- `recent_load_test_required`
