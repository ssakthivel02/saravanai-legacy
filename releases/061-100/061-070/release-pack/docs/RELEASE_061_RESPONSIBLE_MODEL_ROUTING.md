# Release 061 — Responsible Model Routing

## Objective

Route AI requests through approved free-first models using capability, sensitivity, freshness, safety and budget policy.

## Delivered architecture

- Tenant-scoped `model-route-policies` contract.
...
- `restricted_data_external_route_denied`
