...
CREATE TABLE IF NOT EXISTS release_128_records(
...
CREATE INDEX IF NOT EXISTS idx_release_128_tenant_status ON release_128_records(tenant_id,status);
CREATE TABLE IF NOT EXISTS release_128_decisions(
 ...
 FOREIGN KEY(record_id) REFERENCES release_128_records(record_id));
