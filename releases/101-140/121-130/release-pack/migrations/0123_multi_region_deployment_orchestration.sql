...
CREATE TABLE IF NOT EXISTS release_123_records(
...
CREATE INDEX IF NOT EXISTS idx_release_123_tenant_status ON release_123_records(tenant_id,status);
CREATE TABLE IF NOT EXISTS release_123_decisions(
 ...
 FOREIGN KEY(record_id) REFERENCES release_123_records(record_id));
