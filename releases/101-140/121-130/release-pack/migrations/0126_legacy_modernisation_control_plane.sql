...
CREATE TABLE IF NOT EXISTS release_126_records(
...
CREATE INDEX IF NOT EXISTS idx_release_126_tenant_status ON release_126_records(tenant_id,status);
CREATE TABLE IF NOT EXISTS release_126_decisions(
 ...
 FOREIGN KEY(record_id) REFERENCES release_126_records(record_id));
