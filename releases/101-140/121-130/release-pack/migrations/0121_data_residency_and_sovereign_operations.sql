...
CREATE TABLE IF NOT EXISTS release_121_records(
...
CREATE INDEX IF NOT EXISTS idx_release_121_tenant_status ON release_121_records(tenant_id,status);
CREATE TABLE IF NOT EXISTS release_121_decisions(
 ...
 FOREIGN KEY(record_id) REFERENCES release_121_records(record_id));
