...
CREATE TABLE IF NOT EXISTS release_129_records(
...
CREATE INDEX IF NOT EXISTS idx_release_129_tenant_status ON release_129_records(tenant_id,status);
CREATE TABLE IF NOT EXISTS release_129_decisions(
 ...
 FOREIGN KEY(record_id) REFERENCES release_129_records(record_id));
