...
CREATE TABLE IF NOT EXISTS release_127_records(
...
CREATE INDEX IF NOT EXISTS idx_release_127_tenant_status ON release_127_records(tenant_id,status);
CREATE TABLE IF NOT EXISTS release_127_decisions(
 ...
 FOREIGN KEY(record_id) REFERENCES release_127_records(record_id));
