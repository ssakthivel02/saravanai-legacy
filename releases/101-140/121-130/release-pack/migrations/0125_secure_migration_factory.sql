...
CREATE TABLE IF NOT EXISTS release_125_records(
...
CREATE INDEX IF NOT EXISTS idx_release_125_tenant_status ON release_125_records(tenant_id,status);
CREATE TABLE IF NOT EXISTS release_125_decisions(
 ...
 FOREIGN KEY(record_id) REFERENCES release_125_records(record_id));
