...
CREATE TABLE IF NOT EXISTS release_130_records(
...
CREATE INDEX IF NOT EXISTS idx_release_130_tenant_status ON release_130_records(tenant_id,status);
CREATE TABLE IF NOT EXISTS release_130_decisions(
 ...
 FOREIGN KEY(record_id) REFERENCES release_130_records(record_id));
