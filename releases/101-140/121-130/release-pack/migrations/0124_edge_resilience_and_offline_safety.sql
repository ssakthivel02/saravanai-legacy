...
CREATE TABLE IF NOT EXISTS release_124_records(
...
CREATE INDEX IF NOT EXISTS idx_release_124_tenant_status ON release_124_records(tenant_id,status);
CREATE TABLE IF NOT EXISTS release_124_decisions(
 ...
 FOREIGN KEY(record_id) REFERENCES release_124_records(record_id));
