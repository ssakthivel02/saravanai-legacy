...
CREATE TABLE IF NOT EXISTS release_122_records(
...
CREATE INDEX IF NOT EXISTS idx_release_122_tenant_status ON release_122_records(tenant_id,status);
CREATE TABLE IF NOT EXISTS release_122_decisions(
 ...
 FOREIGN KEY(record_id) REFERENCES release_122_records(record_id));
