...
CREATE TABLE IF NOT EXISTS release_113_records(
...
CREATE INDEX IF NOT EXISTS idx_release_113_tenant_status ON release_113_records(tenant_id,status);
CREATE TABLE IF NOT EXISTS release_113_decisions(
 ...
 FOREIGN KEY(record_id) REFERENCES release_113_records(record_id));
