...
CREATE TABLE IF NOT EXISTS release_118_records(
...
CREATE INDEX IF NOT EXISTS idx_release_118_tenant_status ON release_118_records(tenant_id,status);
CREATE TABLE IF NOT EXISTS release_118_decisions(
 ...
 FOREIGN KEY(record_id) REFERENCES release_118_records(record_id));
