...
CREATE TABLE IF NOT EXISTS release_112_records(
...
CREATE INDEX IF NOT EXISTS idx_release_112_tenant_status ON release_112_records(tenant_id,status);
CREATE TABLE IF NOT EXISTS release_112_decisions(
 ...
 FOREIGN KEY(record_id) REFERENCES release_112_records(record_id));
