...
CREATE TABLE IF NOT EXISTS release_116_records(
...
CREATE INDEX IF NOT EXISTS idx_release_116_tenant_status ON release_116_records(tenant_id,status);
CREATE TABLE IF NOT EXISTS release_116_decisions(
 ...
 FOREIGN KEY(record_id) REFERENCES release_116_records(record_id));
