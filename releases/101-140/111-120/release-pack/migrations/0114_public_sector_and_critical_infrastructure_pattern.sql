...
CREATE TABLE IF NOT EXISTS release_114_records(
...
CREATE INDEX IF NOT EXISTS idx_release_114_tenant_status ON release_114_records(tenant_id,status);
CREATE TABLE IF NOT EXISTS release_114_decisions(
 ...
 FOREIGN KEY(record_id) REFERENCES release_114_records(record_id));
