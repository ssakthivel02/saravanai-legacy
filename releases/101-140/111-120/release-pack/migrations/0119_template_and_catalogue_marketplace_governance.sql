...
CREATE TABLE IF NOT EXISTS release_119_records(
...
CREATE INDEX IF NOT EXISTS idx_release_119_tenant_status ON release_119_records(tenant_id,status);
CREATE TABLE IF NOT EXISTS release_119_decisions(
 ...
 FOREIGN KEY(record_id) REFERENCES release_119_records(record_id));
