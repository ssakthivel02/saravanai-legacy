...
CREATE TABLE IF NOT EXISTS release_120_records(
...
CREATE INDEX IF NOT EXISTS idx_release_120_tenant_status ON release_120_records(tenant_id,status);
CREATE TABLE IF NOT EXISTS release_120_decisions(
 ...
 FOREIGN KEY(record_id) REFERENCES release_120_records(record_id));
