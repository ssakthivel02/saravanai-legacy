...
CREATE TABLE IF NOT EXISTS release_111_records(
...
CREATE INDEX IF NOT EXISTS idx_release_111_tenant_status ON release_111_records(tenant_id,status);
CREATE TABLE IF NOT EXISTS release_111_decisions(
 ...
 FOREIGN KEY(record_id) REFERENCES release_111_records(record_id));
