...
CREATE TABLE IF NOT EXISTS release_117_records(
...
CREATE INDEX IF NOT EXISTS idx_release_117_tenant_status ON release_117_records(tenant_id,status);
CREATE TABLE IF NOT EXISTS release_117_decisions(
 ...
 FOREIGN KEY(record_id) REFERENCES release_117_records(record_id));
