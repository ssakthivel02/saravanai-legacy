...
CREATE TABLE IF NOT EXISTS release_115_records(
...
CREATE INDEX IF NOT EXISTS idx_release_115_tenant_status ON release_115_records(tenant_id,status);
CREATE TABLE IF NOT EXISTS release_115_decisions(
 ...
 FOREIGN KEY(record_id) REFERENCES release_115_records(record_id));
