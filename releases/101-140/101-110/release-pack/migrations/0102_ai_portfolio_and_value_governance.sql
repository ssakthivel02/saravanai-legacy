...
CREATE TABLE IF NOT EXISTS release_102_records(
...
CREATE INDEX IF NOT EXISTS idx_release_102_tenant_status ON release_102_records(tenant_id,status);
CREATE TABLE IF NOT EXISTS release_102_decisions(
 ...
 FOREIGN KEY(record_id) REFERENCES release_102_records(record_id));
