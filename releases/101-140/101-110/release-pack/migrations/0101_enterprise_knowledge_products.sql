...
CREATE TABLE IF NOT EXISTS release_101_records(
...
CREATE INDEX IF NOT EXISTS idx_release_101_tenant_status ON release_101_records(tenant_id,status);
CREATE TABLE IF NOT EXISTS release_101_decisions(
 ...
 FOREIGN KEY(record_id) REFERENCES release_101_records(record_id));
