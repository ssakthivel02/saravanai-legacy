...
CREATE TABLE IF NOT EXISTS release_106_records(
...
CREATE INDEX IF NOT EXISTS idx_release_106_tenant_status ON release_106_records(tenant_id,status);
CREATE TABLE IF NOT EXISTS release_106_decisions(
 ...
 FOREIGN KEY(record_id) REFERENCES release_106_records(record_id));
