...
CREATE TABLE IF NOT EXISTS release_107_records(
...
CREATE INDEX IF NOT EXISTS idx_release_107_tenant_status ON release_107_records(tenant_id,status);
CREATE TABLE IF NOT EXISTS release_107_decisions(
 ...
 FOREIGN KEY(record_id) REFERENCES release_107_records(record_id));
