...
CREATE TABLE IF NOT EXISTS release_110_records(
...
CREATE INDEX IF NOT EXISTS idx_release_110_tenant_status ON release_110_records(tenant_id,status);
CREATE TABLE IF NOT EXISTS release_110_decisions(
 ...
 FOREIGN KEY(record_id) REFERENCES release_110_records(record_id));
