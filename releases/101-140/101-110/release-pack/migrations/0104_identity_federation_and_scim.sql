...
CREATE TABLE IF NOT EXISTS release_104_records(
...
CREATE INDEX IF NOT EXISTS idx_release_104_tenant_status ON release_104_records(tenant_id,status);
CREATE TABLE IF NOT EXISTS release_104_decisions(
 ...
 FOREIGN KEY(record_id) REFERENCES release_104_records(record_id));
