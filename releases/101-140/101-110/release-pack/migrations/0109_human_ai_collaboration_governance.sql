...
CREATE TABLE IF NOT EXISTS release_109_records(
...
CREATE INDEX IF NOT EXISTS idx_release_109_tenant_status ON release_109_records(tenant_id,status);
CREATE TABLE IF NOT EXISTS release_109_decisions(
 ...
 FOREIGN KEY(record_id) REFERENCES release_109_records(record_id));
