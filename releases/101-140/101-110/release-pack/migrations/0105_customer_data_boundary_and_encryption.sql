...
CREATE TABLE IF NOT EXISTS release_105_records(
...
CREATE INDEX IF NOT EXISTS idx_release_105_tenant_status ON release_105_records(tenant_id,status);
CREATE TABLE IF NOT EXISTS release_105_decisions(
 ...
 FOREIGN KEY(record_id) REFERENCES release_105_records(record_id));
