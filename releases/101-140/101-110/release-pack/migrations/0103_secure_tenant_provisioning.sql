...
CREATE TABLE IF NOT EXISTS release_103_records(
...
CREATE INDEX IF NOT EXISTS idx_release_103_tenant_status ON release_103_records(tenant_id,status);
CREATE TABLE IF NOT EXISTS release_103_decisions(
 ...
 FOREIGN KEY(record_id) REFERENCES release_103_records(record_id));
