...
CREATE TABLE IF NOT EXISTS release_136_records(
...
CREATE INDEX IF NOT EXISTS idx_release_136_tenant_status ON release_136_records(tenant_id,status);
CREATE TABLE IF NOT EXISTS release_136_decisions(
 ...
 FOREIGN KEY(record_id) REFERENCES release_136_records(record_id));
