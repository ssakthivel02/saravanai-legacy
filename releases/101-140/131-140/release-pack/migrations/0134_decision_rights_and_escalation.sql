...
CREATE TABLE IF NOT EXISTS release_134_records(
...
CREATE INDEX IF NOT EXISTS idx_release_134_tenant_status ON release_134_records(tenant_id,status);
CREATE TABLE IF NOT EXISTS release_134_decisions(
 ...
 FOREIGN KEY(record_id) REFERENCES release_134_records(record_id));
