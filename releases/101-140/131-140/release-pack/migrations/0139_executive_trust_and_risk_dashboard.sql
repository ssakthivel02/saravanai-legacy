...
CREATE TABLE IF NOT EXISTS release_139_records(
...
CREATE INDEX IF NOT EXISTS idx_release_139_tenant_status ON release_139_records(tenant_id,status);
CREATE TABLE IF NOT EXISTS release_139_decisions(
 ...
 FOREIGN KEY(record_id) REFERENCES release_139_records(record_id));
