...
CREATE TABLE IF NOT EXISTS release_135_records(
...
CREATE INDEX IF NOT EXISTS idx_release_135_tenant_status ON release_135_records(tenant_id,status);
CREATE TABLE IF NOT EXISTS release_135_decisions(
 ...
 FOREIGN KEY(record_id) REFERENCES release_135_records(record_id));
