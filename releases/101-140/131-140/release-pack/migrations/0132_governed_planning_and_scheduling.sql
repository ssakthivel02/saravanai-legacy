...
CREATE TABLE IF NOT EXISTS release_132_records(
...
CREATE INDEX IF NOT EXISTS idx_release_132_tenant_status ON release_132_records(tenant_id,status);
CREATE TABLE IF NOT EXISTS release_132_decisions(
 ...
 FOREIGN KEY(record_id) REFERENCES release_132_records(record_id));
