...
CREATE TABLE IF NOT EXISTS release_137_records(
...
CREATE INDEX IF NOT EXISTS idx_release_137_tenant_status ON release_137_records(tenant_id,status);
CREATE TABLE IF NOT EXISTS release_137_decisions(
 ...
 FOREIGN KEY(record_id) REFERENCES release_137_records(record_id));
