...
CREATE TABLE IF NOT EXISTS release_133_records(
...
CREATE INDEX IF NOT EXISTS idx_release_133_tenant_status ON release_133_records(tenant_id,status);
CREATE TABLE IF NOT EXISTS release_133_decisions(
 ...
 FOREIGN KEY(record_id) REFERENCES release_133_records(record_id));
