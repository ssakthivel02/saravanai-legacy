...
CREATE TABLE IF NOT EXISTS release_140_records(
...
CREATE INDEX IF NOT EXISTS idx_release_140_tenant_status ON release_140_records(tenant_id,status);
CREATE TABLE IF NOT EXISTS release_140_decisions(
 ...
 FOREIGN KEY(record_id) REFERENCES release_140_records(record_id));
