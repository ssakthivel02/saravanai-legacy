...
CREATE TABLE IF NOT EXISTS release_138_records(
...
CREATE INDEX IF NOT EXISTS idx_release_138_tenant_status ON release_138_records(tenant_id,status);
CREATE TABLE IF NOT EXISTS release_138_decisions(
 ...
 FOREIGN KEY(record_id) REFERENCES release_138_records(record_id));
