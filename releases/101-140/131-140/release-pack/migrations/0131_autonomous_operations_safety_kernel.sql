...
CREATE TABLE IF NOT EXISTS release_131_records(
...
CREATE INDEX IF NOT EXISTS idx_release_131_tenant_status ON release_131_records(tenant_id,status);
CREATE TABLE IF NOT EXISTS release_131_decisions(
 ...
 FOREIGN KEY(record_id) REFERENCES release_131_records(record_id));
