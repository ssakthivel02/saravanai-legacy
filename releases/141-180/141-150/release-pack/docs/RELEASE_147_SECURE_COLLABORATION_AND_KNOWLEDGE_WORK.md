# Release 147 — Secure Collaboration and Knowledge Work

        ## Objective

        Support comments, reviews, decisions, mentions and shared artefacts with tenant isolation and retention.

        ## Control objectives

        - `tenant_isolation_required`
- `retention_required`
- `external_sharing_default_deny`
