# Release 150 — Experience Assurance Gate

        ## Objective

        Gate user experience release on security, accessibility, localisation, privacy, performance and human review.

        ## Control objectives

        - `security_evidence_required`
- `accessibility_evidence_required`
- `localisation_evidence_required`
