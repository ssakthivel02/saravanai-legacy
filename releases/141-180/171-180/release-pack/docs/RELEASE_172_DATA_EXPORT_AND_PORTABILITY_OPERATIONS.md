# Release 172 — Data Export and Portability Operations

        ## Objective

        Provide tenant-scoped exports with open formats, integrity, access controls, expiry and deletion evidence.

        ## Control objectives

        - `open_format_required`
- `integrity_hash_required`
- `approval_for_restricted_export`
