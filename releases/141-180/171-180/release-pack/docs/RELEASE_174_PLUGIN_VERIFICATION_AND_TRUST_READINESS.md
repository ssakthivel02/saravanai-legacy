# Release 174 — Plugin Verification and Trust Readiness

        ## Objective

        Assess plugins through provenance, permissions, egress, dependencies, signing and revocation without certification claims.

        ## Control objectives

        - `publisher_required`
- `permission_minimisation`
