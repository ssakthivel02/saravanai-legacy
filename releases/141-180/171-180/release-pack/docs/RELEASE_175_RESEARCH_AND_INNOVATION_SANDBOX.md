# Release 175 — Research and Innovation Sandbox

        ## Objective

        Provide isolated experimentation with synthetic data, no production credentials, budgets and automatic expiry.
