# Release 179 — Sustainability Accessibility and Community Impact

        ## Objective

        Assess energy, accessibility, inclusion, local impact and responsible community participation with evidence.

        ## Control objectives

        - `energy_estimate_recorded`
