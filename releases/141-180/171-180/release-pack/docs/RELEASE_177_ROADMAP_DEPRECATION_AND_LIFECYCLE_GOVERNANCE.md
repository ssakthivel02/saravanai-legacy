# Release 177 — Roadmap Deprecation and Lifecycle Governance

        ## Objective

        Manage roadmap commitments, deprecation notices, migrations, support windows and customer communication.

        ## Control objectives

        - `notice_required`
- `sunset_requires_migration_guide`
- `owner_communication_required`
