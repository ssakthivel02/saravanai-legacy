# Release 171 — Open Standards and Interoperability

        ## Objective

        Adopt documented standards, version mappings, compatibility tests and escape paths without lock-in claims.

        ## Control objectives

        - `standards_required`
- `compatibility_tests_required`
- `fallback_required`
