# Release 166 — Data Pipeline and DataOps Control Plane

        ## Objective

        Operate pipelines with contracts, lineage, quality, retries, quarantine and tenant boundaries.

        ## Control objectives

        - `contracts_required`
- `quality_rules_required`
