# Release 170 — Platform Engineering Assurance Gate

        ## Objective

        Gate platform capability release on golden paths, environments, data, reliability, security and rollback evidence.
