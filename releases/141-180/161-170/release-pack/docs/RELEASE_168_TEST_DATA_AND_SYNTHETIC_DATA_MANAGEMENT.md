# Release 168 — Test Data and Synthetic Data Management

        ## Objective

        Create test data with classification, minimisation, synthetic provenance, expiry and production-data prohibitions.
