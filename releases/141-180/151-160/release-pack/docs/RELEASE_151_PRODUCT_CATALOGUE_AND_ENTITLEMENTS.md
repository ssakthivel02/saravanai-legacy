# Release 151 — Product Catalogue and Entitlements

        ## Objective

        Model products, capabilities, plans and tenant entitlements without activating paid services.

        ## Control objectives

        - `capability_scope_required`
- `expiry_supported`
- `paid_activation_forbidden`
