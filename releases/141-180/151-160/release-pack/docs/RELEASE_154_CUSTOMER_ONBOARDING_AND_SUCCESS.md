# Release 154 — Customer Onboarding and Success

        ## Objective

        Provide controlled onboarding, readiness checks, training, adoption goals and accountable success plans.

        ## Control objectives

        - `success_owner_required`
- `goals_required`
