# Release 156 — Service Request Automation

        ## Objective

        Automate repeatable service requests with catalogues, approvals, idempotency, receipts and rollback.

        ## Control objectives

        - `catalogue_item_required`
