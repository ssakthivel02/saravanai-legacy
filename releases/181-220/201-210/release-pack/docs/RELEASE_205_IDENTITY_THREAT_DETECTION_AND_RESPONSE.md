# Release 205 — Identity Threat Detection and Response

        ## Objective

        Detect suspicious authentication, impossible travel, session theft, privilege escalation and service-account misuse.

        ## Control objectives

        - `subject_required`
- `risk_bounded`
- `request_correlation_required`
