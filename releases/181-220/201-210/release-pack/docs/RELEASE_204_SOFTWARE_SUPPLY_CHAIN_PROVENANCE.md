# Release 204 — Software Supply-Chain Provenance

        ## Objective

        Require dependency inventory, SBOM, signatures, build provenance, vulnerability review and revocation capability.
