# Release 206 — Privileged and Insider Risk Controls

        ## Objective

        Govern privileged activity through just-in-time access, four-eyes approval, session evidence, separation and revocation.
