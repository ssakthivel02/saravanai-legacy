# Release 207 — Fraud Account Abuse and Misuse Prevention

        ## Objective

        Detect account farming, credential abuse, automation misuse, quota evasion and fraudulent workflows with appeal paths.

        ## Control objectives

        - `risk_bounded`
- `signals_required`
- `proportionate_action_required`
- `appeal_required`
