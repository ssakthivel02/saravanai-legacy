# Release 185 — Agent Memory Operations

        ## Objective

        Govern working, project and organisational memory through consent, confidence, expiry, correction, deletion and isolation.
