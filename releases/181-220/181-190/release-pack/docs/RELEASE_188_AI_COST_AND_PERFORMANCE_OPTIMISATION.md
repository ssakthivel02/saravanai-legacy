# Release 188 — AI Cost and Performance Optimisation

        ## Objective

        Optimise latency, quality and free-first resource use while enforcing hard budgets and preventing silent paid-provider activation.

        ## Control objectives

        - `quality_floor_required`
- `hard_budget_stop_required`
