# Release 184 — Retrieval and Corpus Operations

        ## Objective

        Operate corpora through ingestion, access control, freshness, lineage, re-indexing, deletion and retrieval evaluation.
