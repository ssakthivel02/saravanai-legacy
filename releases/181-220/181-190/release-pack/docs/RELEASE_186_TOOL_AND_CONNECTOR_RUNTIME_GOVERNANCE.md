# Release 186 — Tool and Connector Runtime Governance

        ## Objective

        Execute tools and connectors only through capability allowlists, egress rules, credential bindings, idempotency and receipts.
