# Release 196 — Privacy-Preserving Analytics

        ## Objective

        Provide aggregated analytics with minimisation, purpose limitation, suppression, access control and re-identification safeguards.

        ## Control objectives

        - `purpose_required`
- `minimum_group_required`
- `identifiers_forbidden`
- `reidentification_forbidden`
