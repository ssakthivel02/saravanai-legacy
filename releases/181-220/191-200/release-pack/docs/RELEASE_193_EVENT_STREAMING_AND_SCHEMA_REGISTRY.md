# Release 193 — Event Streaming and Schema Registry

        ## Objective

        Govern domain events through schemas, compatibility, tenant context, replay, retention, dead-letter and consumer contracts.
