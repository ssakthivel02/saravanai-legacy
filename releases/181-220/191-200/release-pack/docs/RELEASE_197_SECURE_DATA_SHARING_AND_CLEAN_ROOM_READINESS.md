# Release 197 — Secure Data Sharing and Clean-Room Readiness

        ## Objective

        Govern controlled data collaboration through purpose, contracts, field allowlists, query restrictions, output review and expiry.

        ## Control objectives

        - `provider_consumer_distinct`
- `purpose_required`
- `field_allowlist_required`
- `expiry_required`
