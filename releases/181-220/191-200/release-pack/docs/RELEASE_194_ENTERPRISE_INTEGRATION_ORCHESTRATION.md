# Release 194 — Enterprise Integration Orchestration

        ## Objective

        Coordinate APIs, events and batch integration with correlation, retries, compensation, approvals and dependency controls.
...
- `steps_required`
- `retries_bounded`
- `compensation_required_for_writes`
