# Release 195 — Data Quality Observability

        ## Objective

        Measure completeness, validity, uniqueness, freshness, lineage and access-control quality with accountable remediation.
