# Release 200 — Data and Integration Assurance Gate

        ## Objective

        Gate enterprise data capability on contracts, quality, privacy, sharing, records, integration and recovery evidence.
