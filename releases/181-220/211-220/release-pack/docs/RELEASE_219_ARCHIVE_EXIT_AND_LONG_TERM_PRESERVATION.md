# Release 219 — Archive Exit and Long-Term Preservation

        ## Objective

        Preserve essential records, formats, checksums, metadata, access controls and disposal evidence through programme exit.
