# Release 212 — Architecture Portfolio and Technology Radar

        ## Objective

        Manage standards, approved technologies, trials, exceptions, lifecycle stages and architectural decision evidence.
