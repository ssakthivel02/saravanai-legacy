# Release 216 — Workforce and Skills Intelligence

        ## Objective

        Map role capabilities, skills, learning plans, succession risks and workforce decisions without invasive worker surveillance.

        ## Control objectives

        - `skills_required`
- `learning_paths_required`
- `owner_required`
- `invasive_monitoring_forbidden`
