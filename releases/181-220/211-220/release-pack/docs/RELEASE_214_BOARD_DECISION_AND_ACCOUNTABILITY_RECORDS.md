# Release 214 — Board Decision and Accountability Records

        ## Objective

        Record material decisions, alternatives, conflicts, approvals, evidence, residual risks and review dates.
