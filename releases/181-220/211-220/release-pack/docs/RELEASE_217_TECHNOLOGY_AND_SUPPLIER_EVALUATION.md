# Release 217 — Technology and Supplier Evaluation

        ## Objective

        Evaluate products and suppliers through requirements, security, privacy, portability, cost and exit evidence.
