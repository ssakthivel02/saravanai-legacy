...
export function privacySafeMetadata(input: Record<string, unknown>): Record<string, unknown> {
  const blocked = new Set(["prompt","content","document","file","email","phone","address","secret","token"]);
