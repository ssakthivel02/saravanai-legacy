export interface PlatformExperienceAndAdoptionAnalytics {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_339_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required"] as const;

export function validatePlatformExperienceAndAdoptionAnalytics(value: PlatformExperienceAndAdoptionAnalytics): string[] {
  const errors: string[] = [];
