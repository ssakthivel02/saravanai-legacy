export interface PolicyAsCodeDistribution {
  policyId: string;
  version: string;
  owner: string;
  ruleIds: string[];
...
export const RELEASE_334_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tests_before_approval", "exception_governance_required"] as const;

export function validatePolicyAsCodeDistribution(value: PolicyAsCodeDistribution): string[] {
  const errors: string[] = [];
