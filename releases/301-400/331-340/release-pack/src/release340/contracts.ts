export interface PlatformEngineeringAssuranceGate {
  gateId: string;
  releaseRange: '331-340';
...
export const RELEASE_340_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "evidence_index_hash_required", "residual_risks_recorded", "no_go_supported"] as const;

export function validatePlatformEngineeringAssuranceGate(value: PlatformEngineeringAssuranceGate): string[] {
  const errors: string[] = [];
