export interface EphemeralEnvironmentGovernance {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_338_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required"] as const;

export function validateEphemeralEnvironmentGovernance(value: EphemeralEnvironmentGovernance): string[] {
  const errors: string[] = [];
