export interface GlobalSREControlPlane {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_371_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required"] as const;

export function validateGlobalSREControlPlane(value: GlobalSREControlPlane): string[] {
  const errors: string[] = [];
