export interface CrisisCommandAndStakeholderCommunications {
  planId: string;
  tenantId: string;
  owner: string;
  objective: string;
...
export const RELEASE_376_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "dependencies_required", "milestones_required", "rollback_or_exit_required"] as const;

export function validateCrisisCommandAndStakeholderCommunications(value: CrisisCommandAndStakeholderCommunications): string[] {
  const errors: string[] = [];
