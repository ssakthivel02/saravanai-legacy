export interface ChaosExperimentGovernanceV2 {
  executionId: string;
  tenantId: string;
  owner: string;
...
export const RELEASE_374_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "idempotency_required", "kill_switch_required", "production_write_forbidden"] as const;

export function validateChaosExperimentGovernanceV2(value: ChaosExperimentGovernanceV2): string[] {
  const errors: string[] = [];
