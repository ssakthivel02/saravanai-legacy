export interface GlobalResilienceAssuranceGate {
  gateId: string;
  releaseRange: '371-380';
...
export const RELEASE_380_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "evidence_index_hash_required", "residual_risks_recorded", "no_go_supported", "recovery_evidence_required"] as const;

export function validateGlobalResilienceAssuranceGate(value: GlobalResilienceAssuranceGate): string[] {
  const errors: string[] = [];
