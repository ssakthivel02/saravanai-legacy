export interface DifferentialPrivacyBudgetManagement {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_344_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required", "privacy_review_required"] as const;

export function validateDifferentialPrivacyBudgetManagement(value: DifferentialPrivacyBudgetManagement): string[] {
  const errors: string[] = [];
