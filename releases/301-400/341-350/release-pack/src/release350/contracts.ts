export interface DataIntelligenceAssuranceGate {
  gateId: string;
  releaseRange: '341-350';
...
export const RELEASE_350_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "evidence_index_hash_required", "residual_risks_recorded", "no_go_supported"] as const;

export function validateDataIntelligenceAssuranceGate(value: DataIntelligenceAssuranceGate): string[] {
  const errors: string[] = [];
