export interface HomomorphicEncryptionReadiness {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_347_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required", "cryptographic_agility_required"] as const;

export function validateHomomorphicEncryptionReadiness(value: HomomorphicEncryptionReadiness): string[] {
  const errors: string[] = [];
