export interface SemanticLayerAndMetricGovernance {
  recordId: string;
  tenantId: string;
  name: string;
  owner: string;
...
export const RELEASE_342_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "provenance_required", "lifecycle_governance_required"] as const;

export function validateSemanticLayerAndMetricGovernance(value: SemanticLayerAndMetricGovernance): string[] {
  const errors: string[] = [];
