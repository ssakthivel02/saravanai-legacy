export interface DataContractRegistryV2 {
  recordId: string;
  tenantId: string;
  name: string;
  owner: string;
...
export const RELEASE_341_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "provenance_required", "lifecycle_governance_required"] as const;

export function validateDataContractRegistryV2(value: DataContractRegistryV2): string[] {
  const errors: string[] = [];
