...
export const RELEASE_308_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required", "isolated_simulation_required"] as const;

export function validateChangeImpactSimulation(value: ChangeImpactSimulation): string[] {
  const errors: string[] = [];
