export interface DataAndKnowledgeTwin {
  recordId: string;
  tenantId: string;
  name: string;
  owner: string;
...
export const RELEASE_305_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "provenance_required", "lifecycle_governance_required"] as const;

export function validateDataAndKnowledgeTwin(value: DataAndKnowledgeTwin): string[] {
  const errors: string[] = [];
