export interface EnvironmentAndInfrastructureTwin {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_302_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required"] as const;

export function validateEnvironmentAndInfrastructureTwin(value: EnvironmentAndInfrastructureTwin): string[] {
  const errors: string[] = [];
