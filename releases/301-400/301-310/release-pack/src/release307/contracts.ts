export interface CapacityAndCostSimulation {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_307_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required", "isolated_simulation_required"] as const;

export function validateCapacityAndCostSimulation(value: CapacityAndCostSimulation): string[] {
  const errors: string[] = [];
