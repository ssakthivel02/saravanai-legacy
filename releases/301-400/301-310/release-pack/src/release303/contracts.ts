export interface BusinessProcessTwin {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_303_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required"] as const;

export function validateBusinessProcessTwin(value: BusinessProcessTwin): string[] {
  const errors: string[] = [];
