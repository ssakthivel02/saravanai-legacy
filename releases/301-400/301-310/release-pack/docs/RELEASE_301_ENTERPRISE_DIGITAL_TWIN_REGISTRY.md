# Release 301 — Enterprise Digital Twin Registry

    ## Objective

    Register governed digital twins, owners, source systems, models, versions and lifecycle state.
