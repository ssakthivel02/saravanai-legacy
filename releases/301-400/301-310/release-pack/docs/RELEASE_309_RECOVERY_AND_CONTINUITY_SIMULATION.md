# Release 309 — Recovery and Continuity Simulation

    ## Objective

    Rehearse dependency loss, restore, regional failover, supplier failure and return to service.
