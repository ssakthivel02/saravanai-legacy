export interface ChildSafeLearningAndFamilyControlsV2 {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_385_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required", "safeguarding_review_required"] as const;

export function validateChildSafeLearningAndFamilyControlsV2(value: ChildSafeLearningAndFamilyControlsV2): string[] {
  const errors: string[] = [];
