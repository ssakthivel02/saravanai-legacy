export interface KnowledgeGraphQualityV2 {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_381_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required"] as const;

export function validateKnowledgeGraphQualityV2(value: KnowledgeGraphQualityV2): string[] {
  const errors: string[] = [];
