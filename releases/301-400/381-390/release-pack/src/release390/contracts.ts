export interface KnowledgeTrustAssuranceGate {
  gateId: string;
  releaseRange: '381-390';
...
export const RELEASE_390_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "evidence_index_hash_required", "residual_risks_recorded", "no_go_supported"] as const;

export function validateKnowledgeTrustAssuranceGate(value: KnowledgeTrustAssuranceGate): string[] {
  const errors: string[] = [];
