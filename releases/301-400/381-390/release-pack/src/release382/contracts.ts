export interface CitationAndEvidenceIntegrityV2 {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_382_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required"] as const;

export function validateCitationAndEvidenceIntegrityV2(value: CitationAndEvidenceIntegrityV2): string[] {
  const errors: string[] = [];
