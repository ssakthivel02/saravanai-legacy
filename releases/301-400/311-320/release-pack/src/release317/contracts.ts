export interface AgentTestHarnessAndScenarioReplay {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_317_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required", "bounded_agent_authority_required"] as const;

export function validateAgentTestHarnessAndScenarioReplay(value: AgentTestHarnessAndScenarioReplay): string[] {
  const errors: string[] = [];
