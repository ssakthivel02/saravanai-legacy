export interface AgentEngineeringAssuranceGate {
  gateId: string;
  releaseRange: '311-320';
...
export const RELEASE_320_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "evidence_index_hash_required", "residual_risks_recorded", "no_go_supported", "bounded_agent_authority_required"] as const;

export function validateAgentEngineeringAssuranceGate(value: AgentEngineeringAssuranceGate): string[] {
  const errors: string[] = [];
