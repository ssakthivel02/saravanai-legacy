export interface AgentPlanningAndGoalGovernance {
  planId: string;
  tenantId: string;
  owner: string;
  objective: string;
...
export const RELEASE_312_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "dependencies_required", "milestones_required", "rollback_or_exit_required", "bounded_agent_authority_required"] as const;

export function validateAgentPlanningAndGoalGovernance(value: AgentPlanningAndGoalGovernance): string[] {
  const errors: string[] = [];
