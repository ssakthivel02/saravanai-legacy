export interface AgentToolPermissionCompiler {
  policyId: string;
  version: string;
  owner: string;
  ruleIds: string[];
...
export const RELEASE_313_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tests_before_approval", "exception_governance_required", "bounded_agent_authority_required"] as const;

export function validateAgentToolPermissionCompiler(value: AgentToolPermissionCompiler): string[] {
  const errors: string[] = [];
