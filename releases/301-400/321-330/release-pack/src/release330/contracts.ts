export interface CryptographicAgilityAssuranceGate {
  gateId: string;
  releaseRange: '321-330';
...
export const RELEASE_330_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "evidence_index_hash_required", "residual_risks_recorded", "no_go_supported", "cryptographic_agility_required"] as const;

export function validateCryptographicAgilityAssuranceGate(value: CryptographicAgilityAssuranceGate): string[] {
  const errors: string[] = [];
