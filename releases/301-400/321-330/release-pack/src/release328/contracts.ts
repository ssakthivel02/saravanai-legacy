export interface SecurityPolicyVerificationAndModelChecking {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_328_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required", "security_review_required"] as const;

export function validateSecurityPolicyVerificationAndModelChecking(value: SecurityPolicyVerificationAndModelChecking): string[] {
  const errors: string[] = [];
