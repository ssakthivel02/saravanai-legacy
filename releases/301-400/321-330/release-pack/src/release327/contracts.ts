export interface WorkloadIdentityAndSPIFFEReadiness {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_327_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required"] as const;

export function validateWorkloadIdentityAndSPIFFEReadiness(value: WorkloadIdentityAndSPIFFEReadiness): string[] {
  const errors: string[] = [];
