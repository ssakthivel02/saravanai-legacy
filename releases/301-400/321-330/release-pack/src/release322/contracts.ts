export interface KeyAndCertificateLifecycleAutomation {
  executionId: string;
  tenantId: string;
  owner: string;
...
export const RELEASE_322_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "idempotency_required", "kill_switch_required", "production_write_forbidden"] as const;

export function validateKeyAndCertificateLifecycleAutomation(value: KeyAndCertificateLifecycleAutomation): string[] {
  const errors: string[] = [];
