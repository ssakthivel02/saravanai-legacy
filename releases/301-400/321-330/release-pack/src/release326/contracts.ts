export interface ZeroTrustServiceMesh {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_326_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required"] as const;

export function validateZeroTrustServiceMesh(value: ZeroTrustServiceMesh): string[] {
  const errors: string[] = [];
