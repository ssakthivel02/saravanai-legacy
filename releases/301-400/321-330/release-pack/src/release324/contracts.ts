export interface ConfidentialComputingReadiness {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_324_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required"] as const;

export function validateConfidentialComputingReadiness(value: ConfidentialComputingReadiness): string[] {
  const errors: string[] = [];
