export interface SecureEnclaveWorkloadGovernance {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_325_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required"] as const;

export function validateSecureEnclaveWorkloadGovernance(value: SecureEnclaveWorkloadGovernance): string[] {
  const errors: string[] = [];
