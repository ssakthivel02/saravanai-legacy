...
export const RELEASE_321_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "provenance_required", "lifecycle_governance_required", "cryptographic_agility_required"] as const;

export function validateCryptographicAssetInventory(value: CryptographicAssetInventory): string[] {
  const errors: string[] = [];
