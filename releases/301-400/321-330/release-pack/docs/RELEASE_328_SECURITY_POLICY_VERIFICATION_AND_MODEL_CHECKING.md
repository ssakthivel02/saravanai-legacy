# Release 328 — Security Policy Verification and Model Checking

    ## Objective

    Validate security policies for conflicts, unreachable rules, unsafe defaults and bypass paths.
