export interface CriticalInfrastructureCrossSectorExercise {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_369_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required"] as const;

export function validateCriticalInfrastructureCrossSectorExercise(value: CriticalInfrastructureCrossSectorExercise): string[] {
  const errors: string[] = [];
