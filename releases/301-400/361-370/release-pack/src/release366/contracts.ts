export interface LegalServicesConfidentialityPattern {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_366_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required"] as const;

export function validateLegalServicesConfidentialityPattern(value: LegalServicesConfidentialityPattern): string[] {
  const errors: string[] = [];
