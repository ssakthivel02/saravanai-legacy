export interface PublicSectorTransparencyPattern {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_364_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required", "public_accountability_required"] as const;

export function validatePublicSectorTransparencyPattern(value: PublicSectorTransparencyPattern): string[] {
  const errors: string[] = [];
