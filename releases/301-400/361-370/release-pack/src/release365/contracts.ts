export interface EducationAndSafeguardingPattern {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_365_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required"] as const;

export function validateEducationAndSafeguardingPattern(value: EducationAndSafeguardingPattern): string[] {
  const errors: string[] = [];
