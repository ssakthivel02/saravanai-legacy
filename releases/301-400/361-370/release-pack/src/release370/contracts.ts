export interface RegulatedIndustryAssuranceGate {
  gateId: string;
  releaseRange: '361-370';
...
export const RELEASE_370_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "evidence_index_hash_required", "residual_risks_recorded", "no_go_supported"] as const;

export function validateRegulatedIndustryAssuranceGate(value: RegulatedIndustryAssuranceGate): string[] {
  const errors: string[] = [];
