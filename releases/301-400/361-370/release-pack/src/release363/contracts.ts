export interface FinancialServicesConductPattern {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_363_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required", "regulated_advice_forbidden"] as const;

export function validateFinancialServicesConductPattern(value: FinancialServicesConductPattern): string[] {
  const errors: string[] = [];
