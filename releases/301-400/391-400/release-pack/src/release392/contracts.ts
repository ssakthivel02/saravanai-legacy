export interface ArchitectureDebtAndModernisationPortfolio {
  planId: string;
  tenantId: string;
  owner: string;
  objective: string;
...
export const RELEASE_392_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "dependencies_required", "milestones_required", "rollback_or_exit_required"] as const;

export function validateArchitectureDebtAndModernisationPortfolio(value: ArchitectureDebtAndModernisationPortfolio): string[] {
  const errors: string[] = [];
