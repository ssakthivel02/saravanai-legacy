export interface EnterpriseRiskAggregationAndStressTesting {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_396_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required"] as const;

export function validateEnterpriseRiskAggregationAndStressTesting(value: EnterpriseRiskAggregationAndStressTesting): string[] {
  const errors: string[] = [];
