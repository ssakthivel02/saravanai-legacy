# Release 399 — Enterprise Edition v3 General Availability Board

    ## Objective

    Consolidate product, security, privacy, operations, legal, support and resilience evidence.
...
- `operational_acceptance_required`
