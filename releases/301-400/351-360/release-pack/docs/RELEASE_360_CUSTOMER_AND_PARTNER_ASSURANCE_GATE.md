# Release 360 — Customer and Partner Assurance Gate

    ## Objective

    Gate ecosystem capability on customer, partner, support, privacy, redress and exit evidence.
...
- `no_go_supported`
- `customer_redress_required`
- `third_party_risk_review_required`
