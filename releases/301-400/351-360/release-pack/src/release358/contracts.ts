export interface PartnerPerformanceAndRiskMonitoring {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_358_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required", "third_party_risk_review_required"] as const;

export function validatePartnerPerformanceAndRiskMonitoring(value: PartnerPerformanceAndRiskMonitoring): string[] {
  const errors: string[] = [];
