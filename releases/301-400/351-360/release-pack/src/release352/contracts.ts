export interface PartnerAndResellerWorkspace {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_352_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required", "third_party_risk_review_required"] as const;

export function validatePartnerAndResellerWorkspace(value: PartnerAndResellerWorkspace): string[] {
  const errors: string[] = [];
