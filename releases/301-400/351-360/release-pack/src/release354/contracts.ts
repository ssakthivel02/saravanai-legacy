export interface CapabilitySubscriptionAndEntitlementReadiness {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_354_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required"] as const;

export function validateCapabilitySubscriptionAndEntitlementReadiness(value: CapabilitySubscriptionAndEntitlementReadiness): string[] {
  const errors: string[] = [];
