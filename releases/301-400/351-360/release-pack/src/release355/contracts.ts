export interface CustomerHealthAndAdoptionIntelligence {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_355_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required", "customer_redress_required"] as const;

export function validateCustomerHealthAndAdoptionIntelligence(value: CustomerHealthAndAdoptionIntelligence): string[] {
  const errors: string[] = [];
