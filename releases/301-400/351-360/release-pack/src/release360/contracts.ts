export interface CustomerAndPartnerAssuranceGate {
  gateId: string;
  releaseRange: '351-360';
...
export const RELEASE_360_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "evidence_index_hash_required", "residual_risks_recorded", "no_go_supported", "customer_redress_required", "third_party_risk_review_required"] as const;

export function validateCustomerAndPartnerAssuranceGate(value: CustomerAndPartnerAssuranceGate): string[] {
  const errors: string[] = [];
