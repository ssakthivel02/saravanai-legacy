# Release 275 — Search Discovery and Recommendation Governance

        ## Objective

        Operate ranking, search and recommendations with access filtering, explainability, freshness and user controls.

        ## Control objectives

        - `index_provenance_required`
- `access_filter_required`
