# Release 276 — Learning Assessment and Credential Readiness

        ## Objective

        Deliver learning paths and assessments with accessibility, integrity and evidence without claiming accreditation.
