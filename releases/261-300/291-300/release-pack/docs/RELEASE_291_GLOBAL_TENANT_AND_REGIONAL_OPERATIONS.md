# Release 291 — Global Tenant and Regional Operations

        ## Objective

        Operate tenants across regions with data boundaries, localisation, support coverage and regional owners.

        ## Control objectives

        - `regions_required`
- `data_boundary_required`
- `locales_required`
- `regional_owners_required`
