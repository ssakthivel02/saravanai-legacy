# Release 285 — Privacy Operations and Rights Automation

        ## Objective

        Coordinate access, correction, deletion, portability and objection requests with identity verification and legal holds.

        ## Control objectives

        - `identity_verification_required`
- `legal_holds_respected`
- `due_date_required`
