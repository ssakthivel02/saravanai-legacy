# Release 261 — Enterprise Process Catalogue

        ## Objective

        Register business processes, owners, criticality, dependencies, data classes and lifecycle state.

        ## Control objectives

        - `owner_required`
- `criticality_declared`
- `dependencies_mapped`
