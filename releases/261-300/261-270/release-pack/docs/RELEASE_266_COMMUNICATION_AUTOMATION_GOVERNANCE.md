# Release 266 — Communication Automation Governance

        ## Objective

        Automate email, calendar and collaboration actions with consent, recipient checks, templates and send approval.
