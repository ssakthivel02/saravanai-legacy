export interface AgentBehaviourEvaluationAndDriftResponse {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_829_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required", "bounded_agent_authority_required"] as const;

export function validateAgentBehaviourEvaluationAndDriftResponse(value: AgentBehaviourEvaluationAndDriftResponse): string[] {
  const errors: string[] = [];
