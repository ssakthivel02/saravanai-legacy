export interface BoundedAgentRuntimeActivationGate {
  gateId: string;
  releaseRange: '821-830';
...
export const RELEASE_830_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "evidence_index_hash_required", "residual_risks_recorded", "no_go_supported", "bounded_agent_authority_required"] as const;

export function validateBoundedAgentRuntimeActivationGate(value: BoundedAgentRuntimeActivationGate): string[] {
  const errors: string[] = [];
