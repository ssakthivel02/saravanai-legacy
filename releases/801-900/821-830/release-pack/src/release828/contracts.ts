export interface AgentKillSwitchAndEmergencyStop {
  executionId: string;
  tenantId: string;
  actorSubject: string;
  purpose: string;
...
export const RELEASE_828_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "idempotency_required", "kill_switch_required", "production_write_forbidden", "bounded_agent_authority_required"] as const;

export function validateAgentKillSwitchAndEmergencyStop(value: AgentKillSwitchAndEmergencyStop): string[] {
  const errors: string[] = [];
