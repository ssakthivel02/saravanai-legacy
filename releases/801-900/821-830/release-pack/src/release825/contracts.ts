export interface CheckpointAndDurableAgentState {
  requestId: string;
  tenantId: string;
  owner: string;
  inputRef: string;
...
export const RELEASE_825_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "strict_input_schema_required", "idempotency_required", "result_evidence_required", "bounded_agent_authority_required"] as const;

export function validateCheckpointAndDurableAgentState(value: CheckpointAndDurableAgentState): string[] {
  const errors: string[] = [];
