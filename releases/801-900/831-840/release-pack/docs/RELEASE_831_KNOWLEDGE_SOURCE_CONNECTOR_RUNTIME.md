# Release 831 — Knowledge Source Connector Runtime

    ## Objective

    Connect only approved sources using scoped credentials, malware checks, rate limits and provenance capture.
