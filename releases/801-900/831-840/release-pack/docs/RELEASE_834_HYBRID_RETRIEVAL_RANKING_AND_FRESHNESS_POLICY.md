# Release 834 — Hybrid Retrieval Ranking and Freshness Policy

    ## Objective

    Combine lexical, semantic and structured retrieval with authority, freshness and diversity controls.
