# Release 836 — Temporal Fact Verification Runtime

    ## Objective

    Verify current office-holders, versions, laws, prices and other unstable facts using approved fresh sources.
...
- `fresh_source_verification_required`
