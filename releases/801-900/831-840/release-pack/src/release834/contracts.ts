export interface HybridRetrievalRankingAndFreshnessPolicy {
  policyId: string;
  version: string;
  owner: string;
  ruleIds: string[];
...
export const RELEASE_834_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tests_before_approval", "exception_governance_required"] as const;

export function validateHybridRetrievalRankingAndFreshnessPolicy(value: HybridRetrievalRankingAndFreshnessPolicy): string[] {
  const errors: string[] = [];
