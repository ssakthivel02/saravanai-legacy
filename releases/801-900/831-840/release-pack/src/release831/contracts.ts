export interface KnowledgeSourceConnectorRuntime {
  executionId: string;
  tenantId: string;
  actorSubject: string;
  purpose: string;
...
export const RELEASE_831_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "idempotency_required", "kill_switch_required", "production_write_forbidden", "source_authority_required"] as const;

export function validateKnowledgeSourceConnectorRuntime(value: KnowledgeSourceConnectorRuntime): string[] {
  const errors: string[] = [];
