export interface KnowledgeAndResearchRuntimeActivationGate {
  gateId: string;
...
export const RELEASE_840_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "evidence_index_hash_required", "residual_risks_recorded", "no_go_supported", "source_authority_required"] as const;

export function validateKnowledgeAndResearchRuntimeActivationGate(value: KnowledgeAndResearchRuntimeActivationGate): string[] {
  const errors: string[] = [];
