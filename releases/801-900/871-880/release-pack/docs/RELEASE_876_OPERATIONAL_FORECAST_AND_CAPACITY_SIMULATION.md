# Release 876 — Operational Forecast and Capacity Simulation

    ## Objective

    Model demand, capacity, queues, failures and recovery options without presenting forecasts as certainty.
