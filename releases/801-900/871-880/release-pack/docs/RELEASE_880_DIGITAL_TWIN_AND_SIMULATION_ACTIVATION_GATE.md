# Release 880 — Digital Twin and Simulation Activation Gate

    ## Objective

    Gate simulations on models, assumptions, data, isolation, uncertainty, review and recalibration evidence.
