export interface ScenarioComparisonAndSensitivityAnalysis {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_875_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required"] as const;

export function validateScenarioComparisonAndSensitivityAnalysis(value: ScenarioComparisonAndSensitivityAnalysis): string[] {
  const errors: string[] = [];
