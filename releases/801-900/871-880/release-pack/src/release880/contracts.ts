export interface DigitalTwinAndSimulationActivationGate {
  gateId: string;
  releaseRange: '871-880';
...
export const RELEASE_880_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "evidence_index_hash_required", "residual_risks_recorded", "no_go_supported", "uncertainty_disclosure_required", "twin_boundary_required"] as const;

export function validateDigitalTwinAndSimulationActivationGate(value: DigitalTwinAndSimulationActivationGate): string[] {
  const errors: string[] = [];
