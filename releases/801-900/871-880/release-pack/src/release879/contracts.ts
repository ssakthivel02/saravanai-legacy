export interface SimulationModelDriftAndRecalibration {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_879_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required", "uncertainty_disclosure_required"] as const;

export function validateSimulationModelDriftAndRecalibration(value: SimulationModelDriftAndRecalibration): string[] {
  const errors: string[] = [];
