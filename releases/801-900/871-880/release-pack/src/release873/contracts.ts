export interface SyntheticDataAndPrivacyBoundary {
  policyId: string;
  version: string;
  owner: string;
  ruleIds: string[];
...
export const RELEASE_873_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tests_before_approval", "exception_governance_required"] as const;

export function validateSyntheticDataAndPrivacyBoundary(value: SyntheticDataAndPrivacyBoundary): string[] {
  const errors: string[] = [];
