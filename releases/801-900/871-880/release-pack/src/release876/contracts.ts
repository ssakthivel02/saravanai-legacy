export interface OperationalForecastAndCapacitySimulation {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_876_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required", "uncertainty_disclosure_required"] as const;

export function validateOperationalForecastAndCapacitySimulation(value: OperationalForecastAndCapacitySimulation): string[] {
  const errors: string[] = [];
