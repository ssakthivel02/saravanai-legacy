export interface TrustCentreOperationsActivationGate {
  gateId: string;
  releaseRange: '851-860';
...
export const RELEASE_860_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "evidence_index_hash_required", "residual_risks_recorded", "no_go_supported", "unsupported_certification_claims_forbidden"] as const;

export function validateTrustCentreOperationsActivationGate(value: TrustCentreOperationsActivationGate): string[] {
  const errors: string[] = [];
