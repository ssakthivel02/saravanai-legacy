export interface SecurityPrivacyAndAITransparencyProfile {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_852_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required"] as const;

export function validateSecurityPrivacyAndAITransparencyProfile(value: SecurityPrivacyAndAITransparencyProfile): string[] {
  const errors: string[] = [];
