# Release 860 — Trust Centre Operations Activation Gate

    ## Objective

    Gate trust operations on evidence, access, testing, suppliers, obligations, disclosures and correction.
...
- `no_go_supported`
- `unsupported_certification_claims_forbidden`
