export interface EconomicsCapacityAndSustainabilityGate {
  gateId: string;
  releaseRange: '881-890';
...
export const RELEASE_890_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "evidence_index_hash_required", "residual_risks_recorded", "no_go_supported"] as const;

export function validateEconomicsCapacityAndSustainabilityGate(value: EconomicsCapacityAndSustainabilityGate): string[] {
  const errors: string[] = [];
