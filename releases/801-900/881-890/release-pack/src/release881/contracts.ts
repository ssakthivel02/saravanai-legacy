export interface PlatformUnitEconomicsAndCostModel {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_881_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required", "free_first_hard_stop_required"] as const;

export function validatePlatformUnitEconomicsAndCostModel(value: PlatformUnitEconomicsAndCostModel): string[] {
  const errors: string[] = [];
