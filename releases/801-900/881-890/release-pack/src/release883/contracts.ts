export interface CapacityForecastAndAdmissionPlanning {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_883_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required"] as const;

export function validateCapacityForecastAndAdmissionPlanning(value: CapacityForecastAndAdmissionPlanning): string[] {
  const errors: string[] = [];
