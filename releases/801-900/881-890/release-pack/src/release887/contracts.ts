export interface PerformanceEfficiencyAndCostRegression {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_887_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required", "free_first_hard_stop_required"] as const;

export function validatePerformanceEfficiencyAndCostRegression(value: PerformanceEfficiencyAndCostRegression): string[] {
  const errors: string[] = [];
