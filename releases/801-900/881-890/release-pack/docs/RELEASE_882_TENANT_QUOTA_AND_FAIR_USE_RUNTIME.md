# Release 882 — Tenant Quota and Fair-Use Runtime

    ## Objective

    Enforce tenant quotas, burst limits, priority, exceptions, communication and redress.
