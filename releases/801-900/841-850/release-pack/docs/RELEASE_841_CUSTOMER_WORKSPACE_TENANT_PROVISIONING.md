# Release 841 — Customer Workspace Tenant Provisioning

    ## Objective

    Provision private workspaces with tenant configuration, identity, quotas, policies and rollback evidence.
