# Release 846 — Notification Preference and Delivery Runtime

    ## Objective

    Deliver approved notifications using user preferences, consent, quiet hours, accessibility and retries.
