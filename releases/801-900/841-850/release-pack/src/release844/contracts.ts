export interface DocumentAssetAndVersionWorkspace {
  requestId: string;
  tenantId: string;
  owner: string;
  inputRef: string;
...
export const RELEASE_844_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "strict_input_schema_required", "idempotency_required", "result_evidence_required", "workspace_portability_required"] as const;

export function validateDocumentAssetAndVersionWorkspace(value: DocumentAssetAndVersionWorkspace): string[] {
  const errors: string[] = [];
