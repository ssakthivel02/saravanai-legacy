export interface ProjectConversationAndActivityStream {
  requestId: string;
  tenantId: string;
  owner: string;
  inputRef: string;
...
export const RELEASE_843_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "strict_input_schema_required", "idempotency_required", "result_evidence_required"] as const;

export function validateProjectConversationAndActivityStream(value: ProjectConversationAndActivityStream): string[] {
  const errors: string[] = [];
