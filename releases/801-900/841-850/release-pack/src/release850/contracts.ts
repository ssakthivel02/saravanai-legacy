export interface CustomerWorkspaceActivationGate {
  gateId: string;
  releaseRange: '841-850';
...
export const RELEASE_850_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "evidence_index_hash_required", "residual_risks_recorded", "no_go_supported", "workspace_portability_required", "customer_redress_required"] as const;

export function validateCustomerWorkspaceActivationGate(value: CustomerWorkspaceActivationGate): string[] {
  const errors: string[] = [];
