export interface WorkspaceRoleAndDelegationRuntime {
  executionId: string;
  tenantId: string;
  actorSubject: string;
  purpose: string;
...
export const RELEASE_842_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "idempotency_required", "kill_switch_required", "production_write_forbidden", "workspace_portability_required"] as const;

export function validateWorkspaceRoleAndDelegationRuntime(value: WorkspaceRoleAndDelegationRuntime): string[] {
  const errors: string[] = [];
