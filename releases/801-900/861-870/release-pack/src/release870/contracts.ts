export interface GlobalRegionalAndAccessibilityActivationGate {
  gateId: string;
  releaseRange: '861-870';
...
export const RELEASE_870_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "evidence_index_hash_required", "residual_risks_recorded", "no_go_supported", "jurisdiction_control_required", "manual_accessibility_review_required"] as const;

export function validateGlobalRegionalAndAccessibilityActivationGate(value: GlobalRegionalAndAccessibilityActivationGate): string[] {
  const errors: string[] = [];
