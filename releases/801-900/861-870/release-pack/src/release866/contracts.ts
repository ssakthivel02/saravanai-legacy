export interface AccessibleComponentAndJourneyValidation {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_866_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required"] as const;

export function validateAccessibleComponentAndJourneyValidation(value: AccessibleComponentAndJourneyValidation): string[] {
  const errors: string[] = [];
