# Release 870 — Global Regional and Accessibility Activation Gate

    ## Objective

    Gate global operation on jurisdiction, routing, locale, accessibility, consent and sensitive-context evidence.
...
- `manual_accessibility_review_required`
