export interface BreakGlassIdentityOperations {
  planId: string;
  tenantId: string;
  owner: string;
  objective: string;
...
export const RELEASE_808_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "dependencies_required", "milestones_required", "rollback_or_exit_required", "trusted_identity_context_required"] as const;

export function validateBreakGlassIdentityOperations(value: BreakGlassIdentityOperations): string[] {
  const errors: string[] = [];
