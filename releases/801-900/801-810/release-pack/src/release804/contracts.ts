export interface RBACAndABACDecisionEngineV2 {
  policyId: string;
  version: string;
  owner: string;
  ruleIds: string[];
...
export const RELEASE_804_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tests_before_approval", "exception_governance_required"] as const;

export function validateRBACAndABACDecisionEngineV2(value: RBACAndABACDecisionEngineV2): string[] {
  const errors: string[] = [];
