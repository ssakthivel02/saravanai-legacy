# Release 809 — Identity Runtime Observability and Abuse Detection

    ## Objective

    Monitor authentication, authorisation, tenant denials, credential misuse and anomalous privilege patterns.
