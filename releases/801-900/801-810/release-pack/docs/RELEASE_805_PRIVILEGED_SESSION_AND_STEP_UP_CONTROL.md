# Release 805 — Privileged Session and Step-Up Control

    ## Objective

    Require phishing-resistant authentication, short-lived privilege and re-verification for material actions.
