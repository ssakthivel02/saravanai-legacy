# Release 801 — Runtime Identity Context Resolver

    ## Objective

    Resolve authenticated actor, tenant, organisation, session, roles and assurance level from trusted server-side claims.
