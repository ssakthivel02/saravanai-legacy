# Release 891 — Enterprise Platform v8 Runtime Capability Map

    ## Objective

    Map implemented, blueprint, pilot and unsupported capabilities with owners, dependencies and evidence.
