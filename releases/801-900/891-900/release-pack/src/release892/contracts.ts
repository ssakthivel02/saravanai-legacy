export interface ProductionWorkerIntegrationPlanV8 {
  planId: string;
  tenantId: string;
  owner: string;
  objective: string;
...
export const RELEASE_892_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "dependencies_required", "milestones_required", "rollback_or_exit_required", "separate_production_approval_required"] as const;

export function validateProductionWorkerIntegrationPlanV8(value: ProductionWorkerIntegrationPlanV8): string[] {
  const errors: string[] = [];
