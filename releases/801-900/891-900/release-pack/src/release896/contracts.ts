export interface OperationalReadinessAndServiceAcceptanceV6 {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_896_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required"] as const;

export function validateOperationalReadinessAndServiceAcceptanceV6(value: OperationalReadinessAndServiceAcceptanceV6): string[] {
  const errors: string[] = [];
