export interface ControlledTenantPilotAndExitCriteria {
  planId: string;
  tenantId: string;
  owner: string;
  objective: string;
...
export const RELEASE_897_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "dependencies_required", "milestones_required", "rollback_or_exit_required", "tenant_isolation_required"] as const;

export function validateControlledTenantPilotAndExitCriteria(value: ControlledTenantPilotAndExitCriteria): string[] {
  const errors: string[] = [];
