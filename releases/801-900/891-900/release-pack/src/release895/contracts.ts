export interface EndToEndCriticalJourneyTestProgramme {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_895_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required"] as const;

export function validateEndToEndCriticalJourneyTestProgramme(value: EndToEndCriticalJourneyTestProgramme): string[] {
  const errors: string[] = [];
