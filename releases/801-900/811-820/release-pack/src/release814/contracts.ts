export interface PromptAssemblyAndContextPolicy {
  policyId: string;
  version: string;
  owner: string;
  ruleIds: string[];
...
export const RELEASE_814_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tests_before_approval", "exception_governance_required", "prompt_injection_defence_required"] as const;

export function validatePromptAssemblyAndContextPolicy(value: PromptAssemblyAndContextPolicy): string[] {
  const errors: string[] = [];
