export interface AIGatewayProductionActivationGate {
  gateId: string;
  releaseRange: '811-820';
...
export const RELEASE_820_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "evidence_index_hash_required", "residual_risks_recorded", "no_go_supported", "ai_gateway_policy_required", "separate_production_approval_required"] as const;

export function validateAIGatewayProductionActivationGate(value: AIGatewayProductionActivationGate): string[] {
  const errors: string[] = [];
