# Release 817 — AI Request Idempotency and Replay Protection

    ## Objective

    Prevent duplicate side effects and malicious replay using tenant-scoped keys, expiry and payload binding.
