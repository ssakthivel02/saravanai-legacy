# Release 814 — Prompt Assembly and Context Policy

    ## Objective

    Assemble system, user and retrieved context with source boundaries, token budgets and injection controls.
...
- `prompt_injection_defence_required`
