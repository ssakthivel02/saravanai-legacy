export interface DependencyAndPackageAdmission {
  policyId: string;
  version: string;
  owner: string;
  ruleIds: string[];
...
export const RELEASE_654_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tests_before_approval", "exception_governance_required", "dependency_admission_required"] as const;

export function validateDependencyAndPackageAdmission(value: DependencyAndPackageAdmission): string[] {
  const errors: string[] = [];
