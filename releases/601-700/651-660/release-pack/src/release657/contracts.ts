export interface InfrastructureAndPolicyCodeGovernance {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_657_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required", "secure_sdlc_required"] as const;

export function validateInfrastructureAndPolicyCodeGovernance(value: InfrastructureAndPolicyCodeGovernance): string[] {
  const errors: string[] = [];
