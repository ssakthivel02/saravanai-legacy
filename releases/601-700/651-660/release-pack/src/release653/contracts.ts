export interface EphemeralCodeExecutionSandbox {
  executionId: string;
  tenantId: string;
  owner: string;
...
export const RELEASE_653_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "idempotency_required", "kill_switch_required", "production_write_forbidden", "sandbox_isolation_required", "secure_sdlc_required"] as const;

export function validateEphemeralCodeExecutionSandbox(value: EphemeralCodeExecutionSandbox): string[] {
  const errors: string[] = [];
