export interface SecureDeveloperPlatformAssuranceGate {
  gateId: string;
  releaseRange: '651-660';
...
export const RELEASE_660_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "evidence_index_hash_required", "residual_risks_recorded", "no_go_supported"] as const;

export function validateSecureDeveloperPlatformAssuranceGate(value: SecureDeveloperPlatformAssuranceGate): string[] {
  const errors: string[] = [];
