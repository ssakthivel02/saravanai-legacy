export interface BuildReproducibilityAndProvenanceV2 {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_655_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required", "build_provenance_required"] as const;

export function validateBuildReproducibilityAndProvenanceV2(value: BuildReproducibilityAndProvenanceV2): string[] {
  const errors: string[] = [];
