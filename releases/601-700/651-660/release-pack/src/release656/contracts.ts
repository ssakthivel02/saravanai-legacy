export interface TestGenerationAndValidationIntelligence {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_656_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required"] as const;

export function validateTestGenerationAndValidationIntelligence(value: TestGenerationAndValidationIntelligence): string[] {
  const errors: string[] = [];
