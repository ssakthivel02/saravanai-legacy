# Release 661 — Telemetry Contract and Signal Registry

    ## Objective

    Register metrics, logs, traces, events, owners, classifications, retention and quality objectives.
...
- `privacy_safe_telemetry_required`
