export interface IncidentIntelligenceAndTriageAssistant {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_665_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required", "incident_command_required"] as const;

export function validateIncidentIntelligenceAndTriageAssistant(value: IncidentIntelligenceAndTriageAssistant): string[] {
  const errors: string[] = [];
