export interface PostIncidentLearningAndActionTracking {
  planId: string;
  tenantId: string;
  owner: string;
  objective: string;
...
export const RELEASE_669_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "dependencies_required", "milestones_required", "rollback_or_exit_required", "incident_command_required"] as const;

export function validatePostIncidentLearningAndActionTracking(value: PostIncidentLearningAndActionTracking): string[] {
  const errors: string[] = [];
