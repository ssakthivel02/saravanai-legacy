export interface CapacityPerformanceAndSaturationEngineering {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_667_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required"] as const;

export function validateCapacityPerformanceAndSaturationEngineering(value: CapacityPerformanceAndSaturationEngineering): string[] {
  const errors: string[] = [];
