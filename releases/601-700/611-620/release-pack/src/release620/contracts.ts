export interface SecureAgentRuntimeAssuranceGate {
  gateId: string;
  releaseRange: '611-620';
...
export const RELEASE_620_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "evidence_index_hash_required", "residual_risks_recorded", "no_go_supported", "runtime_isolation_required", "bounded_agent_authority_required"] as const;

export function validateSecureAgentRuntimeAssuranceGate(value: SecureAgentRuntimeAssuranceGate): string[] {
  const errors: string[] = [];
