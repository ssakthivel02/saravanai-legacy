...
export const RELEASE_614_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "idempotency_required", "kill_switch_required", "production_write_forbidden", "tool_allowlist_required"] as const;

export function validateToolInvocationGateway(value: ToolInvocationGateway): string[] {
  const errors: string[] = [];
