export interface AgentFailureRecoveryAndCompensation {
  planId: string;
  tenantId: string;
  owner: string;
  objective: string;
...
export const RELEASE_618_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "dependencies_required", "milestones_required", "rollback_or_exit_required", "bounded_agent_authority_required"] as const;

export function validateAgentFailureRecoveryAndCompensation(value: AgentFailureRecoveryAndCompensation): string[] {
  const errors: string[] = [];
