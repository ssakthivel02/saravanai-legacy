# Release 616 — Agent Memory Scope and Expiry

    ## Objective

    Control working, episodic and tenant memory through scope, classification, retention and deletion.
...
- `memory_scope_and_expiry_required`
