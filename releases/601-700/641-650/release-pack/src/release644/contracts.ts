export interface VideoStoryboardAndGenerationPipeline {
  executionId: string;
  tenantId: string;
  owner: string;
...
export const RELEASE_644_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "idempotency_required", "kill_switch_required", "production_write_forbidden", "likeness_review_required"] as const;

export function validateVideoStoryboardAndGenerationPipeline(value: VideoStoryboardAndGenerationPipeline): string[] {
  const errors: string[] = [];
