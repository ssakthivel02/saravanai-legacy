export interface ImagePromptAndEditSpecification {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_642_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required", "image_rights_and_consent_required"] as const;

export function validateImagePromptAndEditSpecification(value: ImagePromptAndEditSpecification): string[] {
  const errors: string[] = [];
