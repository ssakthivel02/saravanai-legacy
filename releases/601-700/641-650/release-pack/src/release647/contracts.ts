export interface ContentModerationAndSensitiveContextReview {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_647_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required"] as const;

export function validateContentModerationAndSensitiveContextReview(value: ContentModerationAndSensitiveContextReview): string[] {
  const errors: string[] = [];
