export interface AudioAndVoiceProductionPipeline {
  executionId: string;
  tenantId: string;
  owner: string;
...
export const RELEASE_643_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "idempotency_required", "kill_switch_required", "production_write_forbidden", "voice_consent_required"] as const;

export function validateAudioAndVoiceProductionPipeline(value: AudioAndVoiceProductionPipeline): string[] {
  const errors: string[] = [];
