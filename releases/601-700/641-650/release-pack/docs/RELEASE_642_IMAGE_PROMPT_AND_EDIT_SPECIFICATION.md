# Release 642 — Image Prompt and Edit Specification

    ## Objective

    Version image prompts and edits with source assets, consent, negative constraints and review.
...
- `image_rights_and_consent_required`
