# Release 629 — Knowledge Feedback and Correction Workflow

    ## Objective

    Capture user feedback, verify issues, correct indexes, notify consumers and preserve audit history.
...
- `knowledge_freshness_required`
- `workflow_exception_path_required`
