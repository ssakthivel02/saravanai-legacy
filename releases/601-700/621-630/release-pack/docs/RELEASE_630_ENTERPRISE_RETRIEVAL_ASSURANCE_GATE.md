# Release 630 — Enterprise Retrieval Assurance Gate

    ## Objective

    Gate retrieval on source approval, parsing, access, quality, citations, freshness and correction evidence.
...
- `no_go_supported`
- `retrieval_access_filter_required`
