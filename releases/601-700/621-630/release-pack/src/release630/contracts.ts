export interface EnterpriseRetrievalAssuranceGate {
  gateId: string;
  releaseRange: '621-630';
...
export const RELEASE_630_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "evidence_index_hash_required", "residual_risks_recorded", "no_go_supported", "retrieval_access_filter_required"] as const;

export function validateEnterpriseRetrievalAssuranceGate(value: EnterpriseRetrievalAssuranceGate): string[] {
  const errors: string[] = [];
