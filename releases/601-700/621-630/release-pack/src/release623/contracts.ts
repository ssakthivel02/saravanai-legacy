export interface ChunkingEmbeddingAndIndexGovernance {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_623_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required"] as const;

export function validateChunkingEmbeddingAndIndexGovernance(value: ChunkingEmbeddingAndIndexGovernance): string[] {
  const errors: string[] = [];
