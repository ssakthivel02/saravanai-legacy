# Release 677 — Process Mining and Improvement without Surveillance

    ## Objective

    Analyse process outcomes and bottlenecks while prohibiting invasive individual monitoring.
...
- `invasive_surveillance_forbidden`
