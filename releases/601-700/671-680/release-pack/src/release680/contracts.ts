export interface BusinessAutomationAssuranceGate {
  gateId: string;
  releaseRange: '671-680';
...
export const RELEASE_680_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "evidence_index_hash_required", "residual_risks_recorded", "no_go_supported"] as const;

export function validateBusinessAutomationAssuranceGate(value: BusinessAutomationAssuranceGate): string[] {
  const errors: string[] = [];
