export interface RulesAndDecisionTableGovernance {
  policyId: string;
  version: string;
  owner: string;
  ruleIds: string[];
...
export const RELEASE_674_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tests_before_approval", "exception_governance_required"] as const;

export function validateRulesAndDecisionTableGovernance(value: RulesAndDecisionTableGovernance): string[] {
  const errors: string[] = [];
