export interface WorkflowDefinitionAndVersionControl {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_672_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required", "workflow_exception_path_required"] as const;

export function validateWorkflowDefinitionAndVersionControl(value: WorkflowDefinitionAndVersionControl): string[] {
  const errors: string[] = [];
