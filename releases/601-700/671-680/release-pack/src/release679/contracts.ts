export interface AutomationValueAndControlMonitoring {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_679_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required"] as const;

export function validateAutomationValueAndControlMonitoring(value: AutomationValueAndControlMonitoring): string[] {
  const errors: string[] = [];
