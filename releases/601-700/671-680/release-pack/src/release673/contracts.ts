export interface HumanTaskInboxAndDelegation {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_673_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required"] as const;

export function validateHumanTaskInboxAndDelegation(value: HumanTaskInboxAndDelegation): string[] {
  const errors: string[] = [];
