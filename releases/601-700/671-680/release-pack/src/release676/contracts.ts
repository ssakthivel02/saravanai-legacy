export interface WorkflowIntegrationAndConnectorSafety {
  executionId: string;
  tenantId: string;
  owner: string;
...
export const RELEASE_676_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "idempotency_required", "kill_switch_required", "production_write_forbidden", "workflow_exception_path_required"] as const;

export function validateWorkflowIntegrationAndConnectorSafety(value: WorkflowIntegrationAndConnectorSafety): string[] {
  const errors: string[] = [];
