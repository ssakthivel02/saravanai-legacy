export interface ProcessMiningAndImprovementWithoutSurveillance {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_677_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required", "invasive_surveillance_forbidden"] as const;

export function validateProcessMiningAndImprovementWithoutSurveillance(value: ProcessMiningAndImprovementWithoutSurveillance): string[] {
  const errors: string[] = [];
