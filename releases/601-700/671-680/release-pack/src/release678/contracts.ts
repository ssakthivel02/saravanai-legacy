export interface WorkflowExceptionAndCaseManagement {
  planId: string;
  tenantId: string;
  owner: string;
  objective: string;
...
export const RELEASE_678_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "dependencies_required", "milestones_required", "rollback_or_exit_required", "workflow_exception_path_required"] as const;

export function validateWorkflowExceptionAndCaseManagement(value: WorkflowExceptionAndCaseManagement): string[] {
  const errors: string[] = [];
