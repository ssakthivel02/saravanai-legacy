export interface ProductionArchitectureAndSecurityReviewV6 {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_692_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required"] as const;

export function validateProductionArchitectureAndSecurityReviewV6(value: ProductionArchitectureAndSecurityReviewV6): string[] {
  const errors: string[] = [];
