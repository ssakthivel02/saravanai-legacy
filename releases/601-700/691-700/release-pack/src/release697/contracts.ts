export interface CustomerAcceptanceAndPilotEvidence {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_697_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required", "customer_redress_required"] as const;

export function validateCustomerAcceptanceAndPilotEvidence(value: CustomerAcceptanceAndPilotEvidence): string[] {
  const errors: string[] = [];
