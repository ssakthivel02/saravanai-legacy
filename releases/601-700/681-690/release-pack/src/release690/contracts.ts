export interface ComplianceAndAssuranceGate {
  gateId: string;
...
export const RELEASE_690_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "evidence_index_hash_required", "residual_risks_recorded", "no_go_supported", "qualified_interpretation_required"] as const;

export function validateComplianceAndAssuranceGate(value: ComplianceAndAssuranceGate): string[] {
  const errors: string[] = [];
