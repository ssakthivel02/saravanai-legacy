...
export const RELEASE_684_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required"] as const;

export function validateControlEffectivenessAssessment(value: ControlEffectivenessAssessment): string[] {
  const errors: string[] = [];
