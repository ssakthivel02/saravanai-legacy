export interface ManagementAssertionAndDisclosureControl {
  policyId: string;
  version: string;
  owner: string;
  ruleIds: string[];
...
export const RELEASE_688_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tests_before_approval", "exception_governance_required"] as const;

export function validateManagementAssertionAndDisclosureControl(value: ManagementAssertionAndDisclosureControl): string[] {
  const errors: string[] = [];
