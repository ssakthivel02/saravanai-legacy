export interface ControlDesignAndTestCatalogueV2 {
  recordId: string;
  tenantId: string;
  name: string;
  owner: string;
...
export const RELEASE_682_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "provenance_required", "lifecycle_governance_required"] as const;

export function validateControlDesignAndTestCatalogueV2(value: ControlDesignAndTestCatalogueV2): string[] {
  const errors: string[] = [];
