export interface AuditRequestAndEvidenceWorkspace {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_687_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required", "independent_audit_boundary_required"] as const;

export function validateAuditRequestAndEvidenceWorkspace(value: AuditRequestAndEvidenceWorkspace): string[] {
  const errors: string[] = [];
