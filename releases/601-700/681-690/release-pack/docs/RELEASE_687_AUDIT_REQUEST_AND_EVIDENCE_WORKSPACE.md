# Release 687 — Audit Request and Evidence Workspace

    ## Objective

    Coordinate scoped audit requests, access, evidence, questions, responses and retention.
...
- `independent_audit_boundary_required`
