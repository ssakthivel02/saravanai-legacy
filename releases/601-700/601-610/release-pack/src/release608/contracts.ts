export interface InferenceCacheAndPrivacyBoundary {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_608_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required", "tenant_cache_isolation_required", "privacy_review_required"] as const;

export function validateInferenceCacheAndPrivacyBoundary(value: InferenceCacheAndPrivacyBoundary): string[] {
  const errors: string[] = [];
