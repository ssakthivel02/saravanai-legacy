export interface ProviderAndModelAdapterContract {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_602_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required", "provider_allowlist_required", "model_risk_review_required"] as const;

export function validateProviderAndModelAdapterContract(value: ProviderAndModelAdapterContract): string[] {
  const errors: string[] = [];
