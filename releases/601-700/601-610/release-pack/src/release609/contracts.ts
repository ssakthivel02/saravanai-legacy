export interface AIRuntimeCapacityForecasting {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_609_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required", "runtime_isolation_required"] as const;

export function validateAIRuntimeCapacityForecasting(value: AIRuntimeCapacityForecasting): string[] {
  const errors: string[] = [];
