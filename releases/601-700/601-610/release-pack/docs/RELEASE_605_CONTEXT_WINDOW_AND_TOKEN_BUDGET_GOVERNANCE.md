# Release 605 — Context Window and Token Budget Governance

    ## Objective

    Control prompt, retrieval and output budgets with truncation, summarisation, evidence and user transparency.
...
- `exception_governance_required`
- `hard_budget_limit_required`
