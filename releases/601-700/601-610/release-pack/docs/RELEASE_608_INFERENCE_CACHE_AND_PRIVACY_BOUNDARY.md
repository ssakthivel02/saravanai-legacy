# Release 608 — Inference Cache and Privacy Boundary

    ## Objective

    Govern semantic and response caches through tenant scope, classification, expiry and invalidation.
...
- `tenant_cache_isolation_required`
