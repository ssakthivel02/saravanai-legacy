export interface DataSovereigntyAssuranceGate {
  gateId: string;
  releaseRange: '631-640';
...
export const RELEASE_640_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "evidence_index_hash_required", "residual_risks_recorded", "no_go_supported", "data_classification_required"] as const;

export function validateDataSovereigntyAssuranceGate(value: DataSovereigntyAssuranceGate): string[] {
  const errors: string[] = [];
