export interface DataSubjectRightsOrchestrationV2 {
  planId: string;
  tenantId: string;
  owner: string;
  objective: string;
...
export const RELEASE_636_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "dependencies_required", "milestones_required", "rollback_or_exit_required", "data_classification_required"] as const;

export function validateDataSubjectRightsOrchestrationV2(value: DataSubjectRightsOrchestrationV2): string[] {
  const errors: string[] = [];
