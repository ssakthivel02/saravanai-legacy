export interface Release238Record {
...
export const RELEASE_238_CONTROLS=["release_238_owner_required", "release_238_evidence_required", "release_238_tenant_scope_required", "release_238_rollback_required"] as const;
export function validateRelease238(v:Release238Record):string[]{
