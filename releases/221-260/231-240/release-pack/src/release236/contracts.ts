export interface Release236Record {
...
export const RELEASE_236_CONTROLS=["release_236_owner_required", "release_236_evidence_required", "release_236_tenant_scope_required", "release_236_rollback_required"] as const;
export function validateRelease236(v:Release236Record):string[]{
