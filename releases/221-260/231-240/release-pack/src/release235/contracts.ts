export interface Release235Record {
...
export const RELEASE_235_CONTROLS=["release_235_owner_required", "release_235_evidence_required", "release_235_tenant_scope_required", "release_235_rollback_required"] as const;
export function validateRelease235(v:Release235Record):string[]{
