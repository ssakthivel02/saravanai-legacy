export interface Release233Record {
...
export const RELEASE_233_CONTROLS=["release_233_owner_required", "release_233_evidence_required", "release_233_tenant_scope_required", "release_233_rollback_required"] as const;
export function validateRelease233(v:Release233Record):string[]{
