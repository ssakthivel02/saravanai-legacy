export interface Release231Record {
...
export const RELEASE_231_CONTROLS=["release_231_owner_required", "release_231_evidence_required", "release_231_tenant_scope_required", "release_231_rollback_required"] as const;
export function validateRelease231(v:Release231Record):string[]{
