# Release 237 — Identity Governance and Access Certification
## Objective
Review roles, privileges, dormant access and separation.
## Controls
- `release_237_owner_required`
- `release_237_evidence_required`
- `release_237_tenant_scope_required`
- `release_237_rollback_required`
## Boundaries
