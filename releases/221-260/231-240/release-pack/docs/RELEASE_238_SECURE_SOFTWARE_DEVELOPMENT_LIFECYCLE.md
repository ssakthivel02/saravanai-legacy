# Release 238 — Secure Software Development Lifecycle
## Objective
Require SBOM, signing, reviews and vulnerability gates.
## Controls
- `release_238_owner_required`
- `release_238_evidence_required`
- `release_238_tenant_scope_required`
- `release_238_rollback_required`
## Boundaries
