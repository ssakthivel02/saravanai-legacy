# Release 231 — External Attack-Surface Management
## Objective
Inventory public exposure, ownership and remediation.
## Controls
- `release_231_owner_required`
- `release_231_evidence_required`
- `release_231_tenant_scope_required`
- `release_231_rollback_required`
## Boundaries
