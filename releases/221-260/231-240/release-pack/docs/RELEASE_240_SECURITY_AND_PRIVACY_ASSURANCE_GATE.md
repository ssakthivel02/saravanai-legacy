# Release 240 — Security and Privacy Assurance Gate
## Objective
Gate release on security, privacy and identity evidence.
## Controls
- `release_240_owner_required`
- `release_240_evidence_required`
- `release_240_tenant_scope_required`
- `release_240_rollback_required`
## Boundaries
