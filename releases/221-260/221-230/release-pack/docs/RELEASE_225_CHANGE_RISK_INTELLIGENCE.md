# Release 225 — Change Risk Intelligence
## Objective
Assess blast radius, tests, approvals and rollback.
## Controls
- `release_225_owner_required`
- `release_225_evidence_required`
- `release_225_tenant_scope_required`
- `release_225_rollback_required`
## Boundaries
