# Release 230 — Enterprise Operations Assurance Gate
## Objective
Gate operations on evidence and recovery readiness.
## Controls
- `release_230_owner_required`
- `release_230_evidence_required`
- `release_230_tenant_scope_required`
- `release_230_rollback_required`
## Boundaries
