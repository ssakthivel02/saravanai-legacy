# Release 223 — Incident Intelligence and Triage
## Objective
Correlate signals, severity, ownership and evidence.
## Controls
- `release_223_owner_required`
- `release_223_evidence_required`
- `release_223_tenant_scope_required`
- `release_223_rollback_required`
## Boundaries
