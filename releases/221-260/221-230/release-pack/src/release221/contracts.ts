export interface Release221Record {
...
export const RELEASE_221_CONTROLS=["release_221_owner_required", "release_221_evidence_required", "release_221_tenant_scope_required", "release_221_rollback_required"] as const;
export function validateRelease221(v:Release221Record):string[]{
