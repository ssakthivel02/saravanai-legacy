export interface Release222Record {
...
export const RELEASE_222_CONTROLS=["release_222_owner_required", "release_222_evidence_required", "release_222_tenant_scope_required", "release_222_rollback_required"] as const;
export function validateRelease222(v:Release222Record):string[]{
