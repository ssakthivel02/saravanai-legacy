export interface Release225Record {
...
export const RELEASE_225_CONTROLS=["release_225_owner_required", "release_225_evidence_required", "release_225_tenant_scope_required", "release_225_rollback_required"] as const;
export function validateRelease225(v:Release225Record):string[]{
