export interface Release226Record {
...
export const RELEASE_226_CONTROLS=["release_226_owner_required", "release_226_evidence_required", "release_226_tenant_scope_required", "release_226_rollback_required"] as const;
export function validateRelease226(v:Release226Record):string[]{
