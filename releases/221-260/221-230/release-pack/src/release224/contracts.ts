export interface Release224Record {
...
export const RELEASE_224_CONTROLS=["release_224_owner_required", "release_224_evidence_required", "release_224_tenant_scope_required", "release_224_rollback_required"] as const;
export function validateRelease224(v:Release224Record):string[]{
