export interface Release230Record {
...
export const RELEASE_230_CONTROLS=["release_230_owner_required", "release_230_evidence_required", "release_230_tenant_scope_required", "release_230_rollback_required"] as const;
export function validateRelease230(v:Release230Record):string[]{
