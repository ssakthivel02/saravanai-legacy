# Release 244 — Edge Device and Fleet Operations
## Objective
Govern device identity, posture, software and retirement.
## Controls
- `release_244_owner_required`
- `release_244_evidence_required`
- `release_244_tenant_scope_required`
- `release_244_rollback_required`
## Boundaries
