# Release 247 — Sustainability and Carbon-Aware Operations
## Objective
Record energy estimates and methodology without unsupported claims.
## Controls
- `release_247_owner_required`
- `release_247_evidence_required`
- `release_247_tenant_scope_required`
- `release_247_rollback_required`
## Boundaries
