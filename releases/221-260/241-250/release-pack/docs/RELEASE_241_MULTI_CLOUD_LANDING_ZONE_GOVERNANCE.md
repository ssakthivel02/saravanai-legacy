# Release 241 — Multi-Cloud Landing-Zone Governance
## Objective
Define identity, network, logging and policy baselines.
## Controls
- `release_241_owner_required`
- `release_241_evidence_required`
- `release_241_tenant_scope_required`
- `release_241_rollback_required`
## Boundaries
