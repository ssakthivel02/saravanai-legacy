# Release 249 — Provider Neutrality and Exit Engineering
## Objective
Maintain open formats, exports and tested exit procedures.
## Controls
- `release_249_owner_required`
- `release_249_evidence_required`
- `release_249_tenant_scope_required`
- `release_249_rollback_required`
## Boundaries
