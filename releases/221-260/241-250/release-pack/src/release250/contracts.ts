export interface Release250Record {
...
export const RELEASE_250_CONTROLS=["release_250_owner_required", "release_250_evidence_required", "release_250_tenant_scope_required", "release_250_rollback_required"] as const;
export function validateRelease250(v:Release250Record):string[]{
