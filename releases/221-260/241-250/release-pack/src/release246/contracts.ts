export interface Release246Record {
...
export const RELEASE_246_CONTROLS=["release_246_owner_required", "release_246_evidence_required", "release_246_tenant_scope_required", "release_246_rollback_required"] as const;
export function validateRelease246(v:Release246Record):string[]{
