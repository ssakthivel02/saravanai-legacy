export interface Release247Record {
...
export const RELEASE_247_CONTROLS=["release_247_owner_required", "release_247_evidence_required", "release_247_tenant_scope_required", "release_247_rollback_required"] as const;
export function validateRelease247(v:Release247Record):string[]{
