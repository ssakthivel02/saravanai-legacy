# Release 252 — Customer Insight and Feedback Governance
## Objective
Collect consented feedback and protect personal data.
## Controls
- `release_252_owner_required`
- `release_252_evidence_required`
- `release_252_tenant_scope_required`
- `release_252_rollback_required`
## Boundaries
