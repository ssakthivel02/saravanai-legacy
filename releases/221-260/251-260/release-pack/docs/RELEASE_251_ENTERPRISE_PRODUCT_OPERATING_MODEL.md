# Release 251 — Enterprise Product Operating Model
## Objective
Define ownership, outcomes, metrics and lifecycle.
## Controls
- `release_251_owner_required`
- `release_251_evidence_required`
- `release_251_tenant_scope_required`
- `release_251_rollback_required`
## Boundaries
