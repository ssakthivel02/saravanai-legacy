# Release 257 — Brand Trust and Public Communications
## Objective
Govern claims, corrections, evidence and accessibility.
## Controls
- `release_257_owner_required`
- `release_257_evidence_required`
- `release_257_tenant_scope_required`
- `release_257_rollback_required`
## Boundaries
