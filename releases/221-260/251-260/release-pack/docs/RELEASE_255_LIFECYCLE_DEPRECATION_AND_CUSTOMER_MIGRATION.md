# Release 255 — Lifecycle Deprecation and Customer Migration
## Objective
Manage notices, migration guides and support windows.
## Controls
- `release_255_owner_required`
- `release_255_evidence_required`
- `release_255_tenant_scope_required`
- `release_255_rollback_required`
## Boundaries
