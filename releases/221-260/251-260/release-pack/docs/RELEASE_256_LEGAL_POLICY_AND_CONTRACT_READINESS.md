# Release 256 — Legal Policy and Contract Readiness
## Objective
Track terms, privacy, acceptable use and jurisdictional review.
## Controls
- `release_256_owner_required`
- `release_256_evidence_required`
- `release_256_tenant_scope_required`
- `release_256_rollback_required`
## Boundaries
