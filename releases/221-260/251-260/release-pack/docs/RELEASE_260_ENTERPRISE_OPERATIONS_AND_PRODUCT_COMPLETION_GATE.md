# Release 260 — Enterprise Operations and Product Completion Gate
## Objective
Close the programme only after accountable approval.
## Controls
- `release_260_owner_required`
- `release_260_evidence_required`
- `release_260_tenant_scope_required`
- `release_260_rollback_required`
## Boundaries
