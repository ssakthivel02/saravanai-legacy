# Release 254 — AI Capability Catalogue and Marketplace
## Objective
Publish governed AI capabilities with scopes and safety evidence.
## Controls
- `release_254_owner_required`
- `release_254_evidence_required`
- `release_254_tenant_scope_required`
- `release_254_rollback_required`
## Boundaries
