export interface Release256Record {
...
export const RELEASE_256_CONTROLS=["release_256_owner_required", "release_256_evidence_required", "release_256_tenant_scope_required", "release_256_rollback_required"] as const;
export function validateRelease256(v:Release256Record):string[]{
