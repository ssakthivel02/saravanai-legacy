export interface Release255Record {
...
export const RELEASE_255_CONTROLS=["release_255_owner_required", "release_255_evidence_required", "release_255_tenant_scope_required", "release_255_rollback_required"] as const;
export function validateRelease255(v:Release255Record):string[]{
