export interface Release252Record {
...
export const RELEASE_252_CONTROLS=["release_252_owner_required", "release_252_evidence_required", "release_252_tenant_scope_required", "release_252_rollback_required"] as const;
export function validateRelease252(v:Release252Record):string[]{
