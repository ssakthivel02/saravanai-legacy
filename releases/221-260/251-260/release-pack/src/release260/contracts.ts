export interface Release260Record {
...
export const RELEASE_260_CONTROLS=["release_260_owner_required", "release_260_evidence_required", "release_260_tenant_scope_required", "release_260_rollback_required"] as const;
export function validateRelease260(v:Release260Record):string[]{
