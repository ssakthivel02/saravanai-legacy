# Release 708 — Model Regression and Release Comparison

    ## Objective

    Compare model and prompt versions against protected baselines, tolerances and critical failure tests.
