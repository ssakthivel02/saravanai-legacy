# Release 704 — Prompt Injection and Tool Abuse Testing

    ## Objective

    Test direct and indirect injection, tool escalation, data exfiltration and policy bypass scenarios.
