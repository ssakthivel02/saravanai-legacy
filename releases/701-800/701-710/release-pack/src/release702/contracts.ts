export interface ModelCapabilityBenchmarkFramework {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_702_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required"] as const;

export function validateModelCapabilityBenchmarkFramework(value: ModelCapabilityBenchmarkFramework): string[] {
  const errors: string[] = [];
