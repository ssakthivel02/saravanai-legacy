export interface EvaluationEvidenceAndDecisionDashboard {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_709_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required", "protected_baseline_required"] as const;

export function validateEvaluationEvidenceAndDecisionDashboard(value: EvaluationEvidenceAndDecisionDashboard): string[] {
  const errors: string[] = [];
