export interface PromptInjectionAndToolAbuseTesting {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_704_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required", "adversarial_testing_required"] as const;

export function validatePromptInjectionAndToolAbuseTesting(value: PromptInjectionAndToolAbuseTesting): string[] {
  const errors: string[] = [];
