export interface SafetyEvaluationAndHarmTaxonomy {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_703_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required", "protected_baseline_required"] as const;

export function validateSafetyEvaluationAndHarmTaxonomy(value: SafetyEvaluationAndHarmTaxonomy): string[] {
  const errors: string[] = [];
