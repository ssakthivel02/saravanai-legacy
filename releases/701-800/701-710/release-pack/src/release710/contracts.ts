export interface AIEvaluationAndRedTeamAssuranceGate {
  gateId: string;
  releaseRange: '701-710';
...
export const RELEASE_710_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "evidence_index_hash_required", "residual_risks_recorded", "no_go_supported", "protected_baseline_required", "rules_of_engagement_required"] as const;

export function validateAIEvaluationAndRedTeamAssuranceGate(value: AIEvaluationAndRedTeamAssuranceGate): string[] {
  const errors: string[] = [];
