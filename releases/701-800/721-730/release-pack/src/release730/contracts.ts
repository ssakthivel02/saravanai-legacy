export interface ApplicationAndWebsiteFactoryAssuranceGate {
  gateId: string;
  releaseRange: '721-730';
...
export const RELEASE_730_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "evidence_index_hash_required", "residual_risks_recorded", "no_go_supported", "web_security_review_required", "secure_sdlc_required"] as const;

export function validateApplicationAndWebsiteFactoryAssuranceGate(value: ApplicationAndWebsiteFactoryAssuranceGate): string[] {
  const errors: string[] = [];
