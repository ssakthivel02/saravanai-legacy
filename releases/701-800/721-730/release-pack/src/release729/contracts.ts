export interface DeploymentPreviewAndReleasePromotion {
  planId: string;
  tenantId: string;
  owner: string;
  objective: string;
...
export const RELEASE_729_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "dependencies_required", "milestones_required", "rollback_or_exit_required"] as const;

export function validateDeploymentPreviewAndReleasePromotion(value: DeploymentPreviewAndReleasePromotion): string[] {
  const errors: string[] = [];
