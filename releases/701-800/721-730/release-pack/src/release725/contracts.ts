export interface FormWorkflowAndDataCaptureBuilder {
  executionId: string;
  tenantId: string;
  owner: string;
...
export const RELEASE_725_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "idempotency_required", "kill_switch_required", "production_write_forbidden", "data_classification_required"] as const;

export function validateFormWorkflowAndDataCaptureBuilder(value: FormWorkflowAndDataCaptureBuilder): string[] {
  const errors: string[] = [];
