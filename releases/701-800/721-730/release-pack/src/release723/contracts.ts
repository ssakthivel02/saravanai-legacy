export interface WebsiteAndWebApplicationScaffold {
  executionId: string;
  tenantId: string;
  owner: string;
...
export const RELEASE_723_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "idempotency_required", "kill_switch_required", "production_write_forbidden", "web_security_review_required", "secure_sdlc_required"] as const;

export function validateWebsiteAndWebApplicationScaffold(value: WebsiteAndWebApplicationScaffold): string[] {
  const errors: string[] = [];
