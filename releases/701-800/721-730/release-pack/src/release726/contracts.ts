export interface ContentManagementAndPublishingWorkflow {
  planId: string;
  tenantId: string;
  owner: string;
  objective: string;
...
export const RELEASE_726_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "dependencies_required", "milestones_required", "rollback_or_exit_required"] as const;

export function validateContentManagementAndPublishingWorkflow(value: ContentManagementAndPublishingWorkflow): string[] {
  const errors: string[] = [];
