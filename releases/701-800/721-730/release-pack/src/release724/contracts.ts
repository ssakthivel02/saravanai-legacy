export interface MobileAndProgressiveWebExperience {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_724_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required", "permission_minimisation_required"] as const;

export function validateMobileAndProgressiveWebExperience(value: MobileAndProgressiveWebExperience): string[] {
  const errors: string[] = [];
