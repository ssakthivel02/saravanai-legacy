# Release 724 — Mobile and Progressive Web Experience

    ## Objective

    Design mobile-first and PWA experiences with offline behaviour, permissions, updates and accessibility.
...
- `permission_minimisation_required`
