# Release 728 — Application Quality Security and Accessibility Testing

    ## Objective

    Test functionality, security, performance, accessibility, localisation and resilient behaviour.
