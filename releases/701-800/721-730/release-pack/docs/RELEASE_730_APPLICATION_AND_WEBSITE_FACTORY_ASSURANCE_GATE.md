# Release 730 — Application and Website Factory Assurance Gate

    ## Objective

    Gate applications on requirements, UX, security, integrations, tests, deployment and support.
...
- `no_go_supported`
- `web_security_review_required`
- `secure_sdlc_required`
