# Release 780 — Data Products and Semantic Layer Assurance Gate

    ## Objective

    Gate data products on contracts, master data, semantics, access, quality, lineage and portability.
