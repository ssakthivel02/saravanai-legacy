export interface DataProductAccessAndUsageControl {
  policyId: string;
  version: string;
  owner: string;
  ruleIds: string[];
...
export const RELEASE_775_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tests_before_approval", "exception_governance_required", "data_classification_required"] as const;

export function validateDataProductAccessAndUsageControl(value: DataProductAccessAndUsageControl): string[] {
  const errors: string[] = [];
