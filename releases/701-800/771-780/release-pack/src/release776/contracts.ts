export interface DataQualityRulesAndObservability {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_776_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required", "data_classification_required"] as const;

export function validateDataQualityRulesAndObservability(value: DataQualityRulesAndObservability): string[] {
  const errors: string[] = [];
