export interface DataProductDeprecationAndPortability {
  planId: string;
  tenantId: string;
  owner: string;
  objective: string;
...
export const RELEASE_779_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "dependencies_required", "milestones_required", "rollback_or_exit_required", "data_classification_required"] as const;

export function validateDataProductDeprecationAndPortability(value: DataProductDeprecationAndPortability): string[] {
  const errors: string[] = [];
