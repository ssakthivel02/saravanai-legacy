export interface DataProductMarketplaceAndDiscovery {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_778_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required", "data_classification_required"] as const;

export function validateDataProductMarketplaceAndDiscovery(value: DataProductMarketplaceAndDiscovery): string[] {
  const errors: string[] = [];
