export interface DeepResearchAssuranceGate {
  gateId: string;
  releaseRange: '711-720';
...
export const RELEASE_720_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "evidence_index_hash_required", "residual_risks_recorded", "no_go_supported", "source_authority_review_required"] as const;

export function validateDeepResearchAssuranceGate(value: DeepResearchAssuranceGate): string[] {
  const errors: string[] = [];
