export interface ResearchReportAndBriefingComposer {
  executionId: string;
  tenantId: string;
  owner: string;
...
export const RELEASE_718_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "idempotency_required", "kill_switch_required", "production_write_forbidden", "source_authority_review_required"] as const;

export function validateResearchReportAndBriefingComposer(value: ResearchReportAndBriefingComposer): string[] {
  const errors: string[] = [];
