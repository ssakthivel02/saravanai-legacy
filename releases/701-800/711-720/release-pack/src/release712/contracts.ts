export interface SourceDiscoveryAndAuthorityRanking {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_712_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required"] as const;

export function validateSourceDiscoveryAndAuthorityRanking(value: SourceDiscoveryAndAuthorityRanking): string[] {
  const errors: string[] = [];
