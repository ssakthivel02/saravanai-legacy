export interface ResearchQualityAndBiasReview {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_717_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required", "source_authority_review_required"] as const;

export function validateResearchQualityAndBiasReview(value: ResearchQualityAndBiasReview): string[] {
  const errors: string[] = [];
