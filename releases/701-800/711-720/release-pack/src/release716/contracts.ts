export interface FactVerificationAndTemporalValidation {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_716_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required"] as const;

export function validateFactVerificationAndTemporalValidation(value: FactVerificationAndTemporalValidation): string[] {
  const errors: string[] = [];
