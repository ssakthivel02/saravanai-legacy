export interface ResearchSynthesisAndArgumentMapping {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_715_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required", "source_authority_review_required"] as const;

export function validateResearchSynthesisAndArgumentMapping(value: ResearchSynthesisAndArgumentMapping): string[] {
  const errors: string[] = [];
