export interface ExecutiveDecisionBriefAndBoardPack {
  executionId: string;
  tenantId: string;
  owner: string;
...
export const RELEASE_785_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "idempotency_required", "kill_switch_required", "production_write_forbidden", "uncertainty_disclosure_required"] as const;

export function validateExecutiveDecisionBriefAndBoardPack(value: ExecutiveDecisionBriefAndBoardPack): string[] {
  const errors: string[] = [];
