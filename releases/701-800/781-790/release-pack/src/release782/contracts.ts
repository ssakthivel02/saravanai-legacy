export interface PortfolioInvestmentAndCapacityPlanning {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_782_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required"] as const;

export function validatePortfolioInvestmentAndCapacityPlanning(value: PortfolioInvestmentAndCapacityPlanning): string[] {
  const errors: string[] = [];
