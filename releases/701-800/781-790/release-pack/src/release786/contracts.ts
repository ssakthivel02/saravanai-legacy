export interface OperationalResilienceCommandView {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_786_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required"] as const;

export function validateOperationalResilienceCommandView(value: OperationalResilienceCommandView): string[] {
  const errors: string[] = [];
