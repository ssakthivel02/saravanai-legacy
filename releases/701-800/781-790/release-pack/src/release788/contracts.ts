export interface BenefitsOutcomesAndValueRealisation {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_788_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required"] as const;

export function validateBenefitsOutcomesAndValueRealisation(value: BenefitsOutcomesAndValueRealisation): string[] {
  const errors: string[] = [];
