# Release 787 — Crisis Command and Stakeholder Coordination

    ## Objective

    Coordinate roles, facts, decisions, actions, communications, welfare and transition.
