export interface GlobalRolloutAndRegionalReadinessV3 {
  planId: string;
  tenantId: string;
  owner: string;
  objective: string;
...
export const RELEASE_796_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "dependencies_required", "milestones_required", "rollback_or_exit_required"] as const;

export function validateGlobalRolloutAndRegionalReadinessV3(value: GlobalRolloutAndRegionalReadinessV3): string[] {
  const errors: string[] = [];
