export interface CustomerPilotAndAdoptionEvidenceV2 {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_797_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required", "customer_redress_required", "ot_safety_boundary_required"] as const;

export function validateCustomerPilotAndAdoptionEvidenceV2(value: CustomerPilotAndAdoptionEvidenceV2): string[] {
  const errors: string[] = [];
