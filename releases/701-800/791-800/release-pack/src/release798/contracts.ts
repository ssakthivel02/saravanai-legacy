export interface CommercialServiceDefinitionWithoutBillingV3 {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_798_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required", "billing_activation_forbidden"] as const;

export function validateCommercialServiceDefinitionWithoutBillingV3(value: CommercialServiceDefinitionWithoutBillingV3): string[] {
  const errors: string[] = [];
