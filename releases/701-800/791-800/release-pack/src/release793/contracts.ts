export interface EnvironmentConfigurationAndSecretReadiness {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_793_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required"] as const;

export function validateEnvironmentConfigurationAndSecretReadiness(value: EnvironmentConfigurationAndSecretReadiness): string[] {
  const errors: string[] = [];
