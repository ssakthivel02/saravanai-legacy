# Release 798 — Commercial Service Definition without Billing v3

    ## Objective

    Validate service definitions, entitlements, quotas, support and disputes while payments remain disabled.
