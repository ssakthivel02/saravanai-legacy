export interface StorageDataProtectionAndRecovery {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_767_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required", "restore_test_required", "data_classification_required"] as const;

export function validateStorageDataProtectionAndRecovery(value: StorageDataProtectionAndRecovery): string[] {
  const errors: string[] = [];
