export interface ComputeClusterAndVirtualisationOperations {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_766_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required"] as const;

export function validateComputeClusterAndVirtualisationOperations(value: ComputeClusterAndVirtualisationOperations): string[] {
  const errors: string[] = [];
