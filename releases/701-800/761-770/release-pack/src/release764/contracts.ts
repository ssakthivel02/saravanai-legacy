export interface ServerAndWorkloadModernisationAssessment {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_764_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required"] as const;

export function validateServerAndWorkloadModernisationAssessment(value: ServerAndWorkloadModernisationAssessment): string[] {
  const errors: string[] = [];
