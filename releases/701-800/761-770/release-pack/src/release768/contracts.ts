export interface CloudSecurityPostureAndConfigurationDrift {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_768_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required", "cloud_policy_required"] as const;

export function validateCloudSecurityPostureAndConfigurationDrift(value: CloudSecurityPostureAndConfigurationDrift): string[] {
  const errors: string[] = [];
