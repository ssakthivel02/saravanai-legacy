# Release 762 — Landing Zone and Account Subscription Factory

    ## Objective

    Provision governed accounts, subscriptions, projects, policies, logging, budgets and network boundaries.
