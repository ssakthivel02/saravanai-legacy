# Release 770 — Hybrid Cloud and Infrastructure Assurance Gate

    ## Objective

    Gate infrastructure on landing zones, IaC, networking, compute, storage, security and migration.
...
- `no_go_supported`
- `cloud_policy_required`
- `infrastructure_change_control_required`
