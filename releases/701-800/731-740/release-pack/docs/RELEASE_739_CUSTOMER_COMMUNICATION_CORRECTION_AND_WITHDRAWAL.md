# Release 739 — Customer Communication Correction and Withdrawal

    ## Objective

    Correct inaccurate messages, stop campaigns, notify affected recipients and preserve evidence.
