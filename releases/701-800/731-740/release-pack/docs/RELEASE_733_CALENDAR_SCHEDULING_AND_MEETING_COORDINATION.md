# Release 733 — Calendar Scheduling and Meeting Coordination

    ## Objective

    Coordinate availability, time zones, attendees, rooms, accessibility, reminders and changes.
