export interface OmnichannelCustomerContactProfile {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_734_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required", "customer_redress_required"] as const;

export function validateOmnichannelCustomerContactProfile(value: OmnichannelCustomerContactProfile): string[] {
  const errors: string[] = [];
