export interface EmailDraftingAndRecipientSafety {
  executionId: string;
  tenantId: string;
  owner: string;
...
export const RELEASE_732_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "idempotency_required", "kill_switch_required", "production_write_forbidden", "recipient_validation_required"] as const;

export function validateEmailDraftingAndRecipientSafety(value: EmailDraftingAndRecipientSafety): string[] {
  const errors: string[] = [];
