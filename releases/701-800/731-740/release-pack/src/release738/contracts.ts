export interface ServiceQualityAndConversationReview {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_738_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required"] as const;

export function validateServiceQualityAndConversationReview(value: ServiceQualityAndConversationReview): string[] {
  const errors: string[] = [];
