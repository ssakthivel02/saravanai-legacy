export interface CaseResolutionAndKnowledgeGuidance {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_736_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required"] as const;

export function validateCaseResolutionAndKnowledgeGuidance(value: CaseResolutionAndKnowledgeGuidance): string[] {
  const errors: string[] = [];
