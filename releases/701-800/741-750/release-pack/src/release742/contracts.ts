export interface PersonalLearningPathAndStudyPlan {
  planId: string;
  tenantId: string;
  owner: string;
  objective: string;
...
export const RELEASE_742_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "dependencies_required", "milestones_required", "rollback_or_exit_required", "learning_integrity_required"] as const;

export function validatePersonalLearningPathAndStudyPlan(value: PersonalLearningPathAndStudyPlan): string[] {
  const errors: string[] = [];
