export interface InterviewSimulationAndFeedback {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_747_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required", "transparent_scoring_required"] as const;

export function validateInterviewSimulationAndFeedback(value: InterviewSimulationAndFeedback): string[] {
  const errors: string[] = [];
