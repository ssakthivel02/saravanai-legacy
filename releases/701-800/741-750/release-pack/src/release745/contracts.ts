export interface LearningProgressAndMasteryEvidence {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_745_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required", "learning_integrity_required"] as const;

export function validateLearningProgressAndMasteryEvidence(value: LearningProgressAndMasteryEvidence): string[] {
  const errors: string[] = [];
