export interface LearningAndCareerServicesAssuranceGate {
  gateId: string;
...
export const RELEASE_750_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "evidence_index_hash_required", "residual_risks_recorded", "no_go_supported", "learning_integrity_required"] as const;

export function validateLearningAndCareerServicesAssuranceGate(value: LearningAndCareerServicesAssuranceGate): string[] {
  const errors: string[] = [];
