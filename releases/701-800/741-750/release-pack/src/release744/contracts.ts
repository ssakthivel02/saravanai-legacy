export interface AssessmentQuestionBankAndIntegrity {
  recordId: string;
  tenantId: string;
  name: string;
  owner: string;
...
export const RELEASE_744_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "provenance_required", "lifecycle_governance_required"] as const;

export function validateAssessmentQuestionBankAndIntegrity(value: AssessmentQuestionBankAndIntegrity): string[] {
  const errors: string[] = [];
