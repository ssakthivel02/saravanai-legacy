# Release 746 — Career Profile Resume and Portfolio Composer

    ## Objective

    Compose evidence-backed resumes, profiles and portfolios with user control and no fabricated claims.
