# Release 742 — Personal Learning Path and Study Plan

    ## Objective

    Create learner-controlled plans using goals, baseline, availability, accessibility and progress evidence.
