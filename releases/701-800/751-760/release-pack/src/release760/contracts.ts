export interface OTEdgeAndIoTAssuranceGate {
  gateId: string;
  releaseRange: '751-760';
...
export const RELEASE_760_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "evidence_index_hash_required", "residual_risks_recorded", "no_go_supported", "ot_safety_boundary_required"] as const;

export function validateOTEdgeAndIoTAssuranceGate(value: OTEdgeAndIoTAssuranceGate): string[] {
  const errors: string[] = [];
