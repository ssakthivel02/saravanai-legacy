export interface OTVulnerabilityAndPatchReadiness {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_756_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required", "ot_safety_boundary_required"] as const;

export function validateOTVulnerabilityAndPatchReadiness(value: OTVulnerabilityAndPatchReadiness): string[] {
  const errors: string[] = [];
