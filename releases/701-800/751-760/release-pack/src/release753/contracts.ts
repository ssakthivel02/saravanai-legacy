export interface IndustrialEdgeWorkloadGovernance {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_753_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required", "operational_safety_required"] as const;

export function validateIndustrialEdgeWorkloadGovernance(value: IndustrialEdgeWorkloadGovernance): string[] {
  const errors: string[] = [];
