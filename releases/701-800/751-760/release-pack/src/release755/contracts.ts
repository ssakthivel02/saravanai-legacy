export interface SensorDataQualityAndMinimisation {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_755_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required", "data_classification_required"] as const;

export function validateSensorDataQualityAndMinimisation(value: SensorDataQualityAndMinimisation): string[] {
  const errors: string[] = [];
