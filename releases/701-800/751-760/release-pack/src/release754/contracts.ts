export interface IoTDeviceIdentityAndLifecycle {
  executionId: string;
  tenantId: string;
  owner: string;
...
export const RELEASE_754_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "idempotency_required", "kill_switch_required", "production_write_forbidden", "ot_safety_boundary_required", "device_identity_required"] as const;

export function validateIoTDeviceIdentityAndLifecycle(value: IoTDeviceIdentityAndLifecycle): string[] {
  const errors: string[] = [];
