export interface InferenceCapacityAndQueueManagement {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_406_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required"] as const;

export function validateInferenceCapacityAndQueueManagement(value: InferenceCapacityAndQueueManagement): string[] {
  const errors: string[] = [];
