export interface RetrievalPipelineOrchestration {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_404_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required", "citation_and_access_filter_required"] as const;

export function validateRetrievalPipelineOrchestration(value: RetrievalPipelineOrchestration): string[] {
  const errors: string[] = [];
