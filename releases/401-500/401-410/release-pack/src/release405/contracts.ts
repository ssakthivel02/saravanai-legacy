export interface AIEvaluationCampaignManagement {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_405_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required", "ai_safety_review_required"] as const;

export function validateAIEvaluationCampaignManagement(value: AIEvaluationCampaignManagement): string[] {
  const errors: string[] = [];
