export interface AIQualityIncidentManagement {
  incidentId: string;
  tenantId: string;
  owner: string;
...
export const RELEASE_408_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "severity_required", "containment_required", "evidence_preservation_required", "ai_safety_review_required"] as const;

export function validateAIQualityIncidentManagement(value: AIQualityIncidentManagement): string[] {
  const errors: string[] = [];
