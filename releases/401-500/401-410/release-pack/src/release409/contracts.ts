export interface AIPortfolioValueAndRiskReporting {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_409_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required", "ai_safety_review_required"] as const;

export function validateAIPortfolioValueAndRiskReporting(value: AIPortfolioValueAndRiskReporting): string[] {
  const errors: string[] = [];
