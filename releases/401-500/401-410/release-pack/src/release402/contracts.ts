export interface ModelRoutingAndSelectionPolicy {
  policyId: string;
  version: string;
  owner: string;
  ruleIds: string[];
...
export const RELEASE_402_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tests_before_approval", "exception_governance_required", "model_risk_review_required"] as const;

export function validateModelRoutingAndSelectionPolicy(value: ModelRoutingAndSelectionPolicy): string[] {
  const errors: string[] = [];
