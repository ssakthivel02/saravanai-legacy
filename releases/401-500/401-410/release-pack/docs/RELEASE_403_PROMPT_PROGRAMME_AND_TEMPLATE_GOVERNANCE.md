# Release 403 — Prompt Programme and Template Governance

    ## Objective

    Version prompts, variables, owners, test cases, approvals, redaction and rollback.
...
- `prompt_injection_controls_required`
