export interface SovereignAIDeploymentProfile {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_411_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required", "ai_safety_review_required", "jurisdiction_and_custody_required"] as const;

export function validateSovereignAIDeploymentProfile(value: SovereignAIDeploymentProfile): string[] {
  const errors: string[] = [];
