export interface ConstrainedComputeOptimisation {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_416_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required"] as const;

export function validateConstrainedComputeOptimisation(value: ConstrainedComputeOptimisation): string[] {
  const errors: string[] = [];
