export interface OfflineUpdateAndPatchGovernance {
  executionId: string;
  tenantId: string;
  owner: string;
...
export const RELEASE_417_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "idempotency_required", "kill_switch_required", "production_write_forbidden", "signed_offline_package_required"] as const;

export function validateOfflineUpdateAndPatchGovernance(value: OfflineUpdateAndPatchGovernance): string[] {
  const errors: string[] = [];
