export interface EdgeAIPrivacyAndSensorMinimisation {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_418_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required", "ai_safety_review_required", "device_posture_required", "privacy_review_required"] as const;

export function validateEdgeAIPrivacyAndSensorMinimisation(value: EdgeAIPrivacyAndSensorMinimisation): string[] {
  const errors: string[] = [];
