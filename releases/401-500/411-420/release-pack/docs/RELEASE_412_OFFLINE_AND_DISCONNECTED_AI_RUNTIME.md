# Release 412 — Offline and Disconnected AI Runtime

    ## Objective

    Operate approved AI functions without network dependency using signed packages and bounded storage.
...
- `signed_offline_package_required`
