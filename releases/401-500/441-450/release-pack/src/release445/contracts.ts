export interface HRAndWorkforceSystemIntegration {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_445_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required"] as const;

export function validateHRAndWorkforceSystemIntegration(value: HRAndWorkforceSystemIntegration): string[] {
  const errors: string[] = [];
