export interface ApplicationPortfolioRationalisation {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_442_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required"] as const;

export function validateApplicationPortfolioRationalisation(value: ApplicationPortfolioRationalisation): string[] {
  const errors: string[] = [];
