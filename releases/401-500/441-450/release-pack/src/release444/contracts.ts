export interface CRMAndCustomerDataIntegration {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_444_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required", "data_classification_required", "customer_redress_required"] as const;

export function validateCRMAndCustomerDataIntegration(value: CRMAndCustomerDataIntegration): string[] {
  const errors: string[] = [];
