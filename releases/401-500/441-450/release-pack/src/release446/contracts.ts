export interface FinanceAndProcurementIntegration {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_446_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required"] as const;

export function validateFinanceAndProcurementIntegration(value: FinanceAndProcurementIntegration): string[] {
  const errors: string[] = [];
