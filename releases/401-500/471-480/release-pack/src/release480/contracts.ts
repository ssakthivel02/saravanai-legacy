export interface EngineeringIntelligenceAssuranceGate {
  gateId: string;
  releaseRange: '471-480';
...
export const RELEASE_480_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "evidence_index_hash_required", "residual_risks_recorded", "no_go_supported"] as const;

export function validateEngineeringIntelligenceAssuranceGate(value: EngineeringIntelligenceAssuranceGate): string[] {
  const errors: string[] = [];
