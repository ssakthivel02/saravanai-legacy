export interface CodeReviewQualityAndPolicy {
  policyId: string;
  version: string;
  owner: string;
  ruleIds: string[];
...
export const RELEASE_472_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tests_before_approval", "exception_governance_required", "secure_sdlc_required"] as const;

export function validateCodeReviewQualityAndPolicy(value: CodeReviewQualityAndPolicy): string[] {
  const errors: string[] = [];
