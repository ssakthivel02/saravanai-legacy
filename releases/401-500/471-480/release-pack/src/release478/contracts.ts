export interface TechnicalDebtAndRefactoringIntelligence {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_478_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required"] as const;

export function validateTechnicalDebtAndRefactoringIntelligence(value: TechnicalDebtAndRefactoringIntelligence): string[] {
  const errors: string[] = [];
