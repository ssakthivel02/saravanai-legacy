export interface TestIntelligenceAndCoverageRisk {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_473_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required"] as const;

export function validateTestIntelligenceAndCoverageRisk(value: TestIntelligenceAndCoverageRisk): string[] {
  const errors: string[] = [];
