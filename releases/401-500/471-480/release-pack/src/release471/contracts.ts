export interface EngineeringWorkItemIntelligence {
  recordId: string;
  tenantId: string;
  name: string;
  owner: string;
...
export const RELEASE_471_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "provenance_required", "lifecycle_governance_required"] as const;

export function validateEngineeringWorkItemIntelligence(value: EngineeringWorkItemIntelligence): string[] {
  const errors: string[] = [];
