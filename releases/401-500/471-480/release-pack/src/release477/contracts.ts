export interface SecureCodingAssistantGovernance {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_477_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required"] as const;

export function validateSecureCodingAssistantGovernance(value: SecureCodingAssistantGovernance): string[] {
  const errors: string[] = [];
