# Release 475 — Developer Environment and Toolchain Governance

    ## Objective

    Govern editors, extensions, packages, credentials, updates, telemetry and support.
