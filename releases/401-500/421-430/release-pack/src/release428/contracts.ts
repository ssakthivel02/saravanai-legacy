export interface CloudAndSaaSSecurityPostureOperations {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_428_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required", "security_review_required"] as const;

export function validateCloudAndSaaSSecurityPostureOperations(value: CloudAndSaaSSecurityPostureOperations): string[] {
  const errors: string[] = [];
