export interface DetectionEngineeringLifecycle {
  recordId: string;
  tenantId: string;
  name: string;
  owner: string;
...
export const RELEASE_423_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "provenance_required", "lifecycle_governance_required"] as const;

export function validateDetectionEngineeringLifecycle(value: DetectionEngineeringLifecycle): string[] {
  const errors: string[] = [];
