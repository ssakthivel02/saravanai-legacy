export interface SecurityAnalyticsAndCorrelation {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_424_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required", "security_review_required"] as const;

export function validateSecurityAnalyticsAndCorrelation(value: SecurityAnalyticsAndCorrelation): string[] {
  const errors: string[] = [];
