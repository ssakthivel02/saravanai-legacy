export interface CyberThreatHuntingProgramme {
  planId: string;
  tenantId: string;
  owner: string;
  objective: string;
...
export const RELEASE_429_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "dependencies_required", "milestones_required", "rollback_or_exit_required", "threat_intelligence_handling_required"] as const;

export function validateCyberThreatHuntingProgramme(value: CyberThreatHuntingProgramme): string[] {
  const errors: string[] = [];
