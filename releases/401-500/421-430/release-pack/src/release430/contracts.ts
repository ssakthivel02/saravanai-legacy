export interface SecurityOperationsAssuranceGate {
  gateId: string;
  releaseRange: '421-430';
...
export const RELEASE_430_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "evidence_index_hash_required", "residual_risks_recorded", "no_go_supported", "security_review_required"] as const;

export function validateSecurityOperationsAssuranceGate(value: SecurityOperationsAssuranceGate): string[] {
  const errors: string[] = [];
