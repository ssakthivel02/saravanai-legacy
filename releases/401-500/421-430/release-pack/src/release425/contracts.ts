export interface AutomatedContainmentSafety {
  executionId: string;
  tenantId: string;
  owner: string;
...
export const RELEASE_425_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "idempotency_required", "kill_switch_required", "production_write_forbidden"] as const;

export function validateAutomatedContainmentSafety(value: AutomatedContainmentSafety): string[] {
  const errors: string[] = [];
