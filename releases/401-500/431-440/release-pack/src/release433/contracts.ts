export interface BatchAndStreamProcessingGovernance {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_433_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required"] as const;

export function validateBatchAndStreamProcessingGovernance(value: BatchAndStreamProcessingGovernance): string[] {
  const errors: string[] = [];
