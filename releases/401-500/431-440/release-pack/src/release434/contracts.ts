export interface DataQualityRulesAndObservabilityV2 {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_434_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required", "data_classification_required"] as const;

export function validateDataQualityRulesAndObservabilityV2(value: DataQualityRulesAndObservabilityV2): string[] {
  const errors: string[] = [];
