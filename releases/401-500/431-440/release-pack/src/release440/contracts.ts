export interface GovernedDataPlatformAssuranceGate {
  gateId: string;
  releaseRange: '431-440';
...
export const RELEASE_440_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "evidence_index_hash_required", "residual_risks_recorded", "no_go_supported", "data_classification_required"] as const;

export function validateGovernedDataPlatformAssuranceGate(value: GovernedDataPlatformAssuranceGate): string[] {
  const errors: string[] = [];
