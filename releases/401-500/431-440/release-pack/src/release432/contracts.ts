export interface DataIngestionAndChangeDataCapture {
  executionId: string;
  tenantId: string;
  owner: string;
...
export const RELEASE_432_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "idempotency_required", "kill_switch_required", "production_write_forbidden", "data_classification_required"] as const;

export function validateDataIngestionAndChangeDataCapture(value: DataIngestionAndChangeDataCapture): string[] {
  const errors: string[] = [];
