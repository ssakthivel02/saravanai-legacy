export interface CustomerExperienceAssuranceGate {
  gateId: string;
  releaseRange: '451-460';
...
export const RELEASE_460_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "evidence_index_hash_required", "residual_risks_recorded", "no_go_supported", "customer_redress_required"] as const;

export function validateCustomerExperienceAssuranceGate(value: CustomerExperienceAssuranceGate): string[] {
  const errors: string[] = [];
