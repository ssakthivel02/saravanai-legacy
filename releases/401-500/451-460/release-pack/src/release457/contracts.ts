export interface CustomerFeedbackAndResearchOperations {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_457_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required", "customer_redress_required"] as const;

export function validateCustomerFeedbackAndResearchOperations(value: CustomerFeedbackAndResearchOperations): string[] {
  const errors: string[] = [];
