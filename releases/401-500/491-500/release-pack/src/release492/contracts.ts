export interface ProductionReadinessReviewV4 {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_492_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required"] as const;

export function validateProductionReadinessReviewV4(value: ProductionReadinessReviewV4): string[] {
  const errors: string[] = [];
