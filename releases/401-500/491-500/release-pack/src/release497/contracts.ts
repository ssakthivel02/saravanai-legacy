export interface CommercialAndEntitlementReadinessWithoutBilling {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_497_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required", "billing_activation_forbidden"] as const;

export function validateCommercialAndEntitlementReadinessWithoutBilling(value: CommercialAndEntitlementReadinessWithoutBilling): string[] {
  const errors: string[] = [];
