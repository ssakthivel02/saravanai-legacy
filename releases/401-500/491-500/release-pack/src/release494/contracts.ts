export interface GlobalLaunchAndRegionalRollout {
  planId: string;
  tenantId: string;
  owner: string;
  objective: string;
...
export const RELEASE_494_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "dependencies_required", "milestones_required", "rollback_or_exit_required", "rollback_and_support_required"] as const;

export function validateGlobalLaunchAndRegionalRollout(value: GlobalLaunchAndRegionalRollout): string[] {
  const errors: string[] = [];
