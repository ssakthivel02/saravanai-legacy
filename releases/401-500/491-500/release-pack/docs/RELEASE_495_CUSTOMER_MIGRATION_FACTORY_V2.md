# Release 495 — Customer Migration Factory v2

    ## Objective

    Migrate tenants through discovery, rehearsal, compatibility, cutover, reconciliation and rollback.
...
- `rehearsal_and_reconciliation_required`
