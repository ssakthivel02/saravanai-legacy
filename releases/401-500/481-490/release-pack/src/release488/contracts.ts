export interface DigitalTrustTransparencyReporting {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_488_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required"] as const;

export function validateDigitalTrustTransparencyReporting(value: DigitalTrustTransparencyReporting): string[] {
  const errors: string[] = [];
