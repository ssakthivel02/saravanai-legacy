export interface CrossBorderDataTransferGovernance {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_482_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required", "data_classification_required"] as const;

export function validateCrossBorderDataTransferGovernance(value: CrossBorderDataTransferGovernance): string[] {
  const errors: string[] = [];
