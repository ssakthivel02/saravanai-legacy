export interface GlobalDigitalTrustAssuranceGate {
  gateId: string;
  releaseRange: '481-490';
...
export const RELEASE_490_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "evidence_index_hash_required", "residual_risks_recorded", "no_go_supported"] as const;

export function validateGlobalDigitalTrustAssuranceGate(value: GlobalDigitalTrustAssuranceGate): string[] {
  const errors: string[] = [];
