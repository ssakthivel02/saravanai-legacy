export interface RecordsManagementAndDefensibleDisposal {
  policyId: string;
  version: string;
  owner: string;
  ruleIds: string[];
...
export const RELEASE_486_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tests_before_approval", "exception_governance_required"] as const;

export function validateRecordsManagementAndDefensibleDisposal(value: RecordsManagementAndDefensibleDisposal): string[] {
  const errors: string[] = [];
