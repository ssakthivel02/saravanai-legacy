export interface DigitalIdentityTrustFramework {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_484_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required", "identity_assurance_required"] as const;

export function validateDigitalIdentityTrustFramework(value: DigitalIdentityTrustFramework): string[] {
  const errors: string[] = [];
