export interface SustainabilityAndSocialImpactGate {
  gateId: string;
  releaseRange: '461-470';
...
export const RELEASE_470_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "evidence_index_hash_required", "residual_risks_recorded", "no_go_supported", "methodology_disclosure_required"] as const;

export function validateSustainabilityAndSocialImpactGate(value: SustainabilityAndSocialImpactGate): string[] {
  const errors: string[] = [];
