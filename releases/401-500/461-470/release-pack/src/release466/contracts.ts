export interface WorkerWellbeingAndResponsibleAutomation {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_466_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required", "invasive_surveillance_forbidden"] as const;

export function validateWorkerWellbeingAndResponsibleAutomation(value: WorkerWellbeingAndResponsibleAutomation): string[] {
  const errors: string[] = [];
