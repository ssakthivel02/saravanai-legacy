export interface CommunityAndPublicInterestImpact {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_467_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required", "public_interest_review_required"] as const;

export function validateCommunityAndPublicInterestImpact(value: CommunityAndPublicInterestImpact): string[] {
  const errors: string[] = [];
