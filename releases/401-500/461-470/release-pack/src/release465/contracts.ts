export interface EnvironmentalRiskAndDependencyAssessment {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_465_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required"] as const;

export function validateEnvironmentalRiskAndDependencyAssessment(value: EnvironmentalRiskAndDependencyAssessment): string[] {
  const errors: string[] = [];
