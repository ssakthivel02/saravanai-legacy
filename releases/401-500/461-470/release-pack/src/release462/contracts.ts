export interface CarbonAwareWorkloadSchedulingV2 {
  policyId: string;
  version: string;
  owner: string;
  ruleIds: string[];
...
export const RELEASE_462_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tests_before_approval", "exception_governance_required"] as const;

export function validateCarbonAwareWorkloadSchedulingV2(value: CarbonAwareWorkloadSchedulingV2): string[] {
  const errors: string[] = [];
