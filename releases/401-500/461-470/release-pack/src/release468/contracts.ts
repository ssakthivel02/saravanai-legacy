export interface ResponsibleInnovationReviewBoard {
  decisionId: string;
...
export const RELEASE_468_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "alternatives_required", "conflicts_declared", "multi_party_approval_required"] as const;

export function validateResponsibleInnovationReviewBoard(value: ResponsibleInnovationReviewBoard): string[] {
  const errors: string[] = [];
