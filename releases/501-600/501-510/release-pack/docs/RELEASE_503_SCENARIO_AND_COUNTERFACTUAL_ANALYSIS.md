# Release 503 — Scenario and Counterfactual Analysis

    ## Objective

    Compare plausible scenarios and counterfactuals using explicit assumptions, sensitivity and limitations.
