# Release 508 — Bias Fairness and Distributional Review

    ## Objective

    Assess decision impacts across relevant groups using justified methods and human interpretation.
...
- `distributional_review_required`
