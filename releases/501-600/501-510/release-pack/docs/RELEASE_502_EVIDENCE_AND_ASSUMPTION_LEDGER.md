# Release 502 — Evidence and Assumption Ledger

    ## Objective

    Record evidence, assumptions, uncertainty, provenance, expiry and challenge history for material decisions.
