export interface BiasFairnessAndDistributionalReview {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_508_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required", "distributional_review_required"] as const;

export function validateBiasFairnessAndDistributionalReview(value: BiasFairnessAndDistributionalReview): string[] {
  const errors: string[] = [];
