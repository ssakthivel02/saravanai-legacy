export interface ScenarioAndCounterfactualAnalysis {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_503_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required"] as const;

export function validateScenarioAndCounterfactualAnalysis(value: ScenarioAndCounterfactualAnalysis): string[] {
  const errors: string[] = [];
