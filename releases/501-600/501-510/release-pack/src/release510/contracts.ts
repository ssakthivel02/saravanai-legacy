export interface DecisionIntelligenceAssuranceGate {
  gateId: string;
  releaseRange: '501-510';
...
export const RELEASE_510_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "evidence_index_hash_required", "residual_risks_recorded", "no_go_supported", "decision_traceability_required"] as const;

export function validateDecisionIntelligenceAssuranceGate(value: DecisionIntelligenceAssuranceGate): string[] {
  const errors: string[] = [];
