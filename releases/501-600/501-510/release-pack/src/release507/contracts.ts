export interface DecisionOutcomeMonitoring {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_507_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required", "decision_traceability_required"] as const;

export function validateDecisionOutcomeMonitoring(value: DecisionOutcomeMonitoring): string[] {
  const errors: string[] = [];
