export interface DecisionExplanationAndTraceability {
  decisionId: string;
...
export const RELEASE_505_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "alternatives_required", "conflicts_declared", "multi_party_approval_required", "decision_traceability_required"] as const;

export function validateDecisionExplanationAndTraceability(value: DecisionExplanationAndTraceability): string[] {
  const errors: string[] = [];
