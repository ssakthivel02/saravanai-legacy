export interface MultiCriteriaDecisionAnalysis {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_504_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required", "decision_traceability_required"] as const;

export function validateMultiCriteriaDecisionAnalysis(value: MultiCriteriaDecisionAnalysis): string[] {
  const errors: string[] = [];
