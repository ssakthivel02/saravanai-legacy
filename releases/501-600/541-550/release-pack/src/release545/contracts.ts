export interface DelegatedGuardianAndRepresentativeAccess {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_545_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required"] as const;

export function validateDelegatedGuardianAndRepresentativeAccess(value: DelegatedGuardianAndRepresentativeAccess): string[] {
  const errors: string[] = [];
