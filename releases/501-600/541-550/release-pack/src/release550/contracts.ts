export interface IdentityTrustAssuranceGate {
  gateId: string;
  releaseRange: '541-550';
...
export const RELEASE_550_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "evidence_index_hash_required", "residual_risks_recorded", "no_go_supported", "identity_assurance_required"] as const;

export function validateIdentityTrustAssuranceGate(value: IdentityTrustAssuranceGate): string[] {
  const errors: string[] = [];
