export interface IdentityProofingAndAssurance {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_541_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required", "identity_assurance_required"] as const;

export function validateIdentityProofingAndAssurance(value: IdentityProofingAndAssurance): string[] {
  const errors: string[] = [];
