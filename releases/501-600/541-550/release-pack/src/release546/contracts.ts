export interface PrivilegedIdentityGovernanceV2 {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_546_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required", "identity_assurance_required"] as const;

export function validatePrivilegedIdentityGovernanceV2(value: PrivilegedIdentityGovernanceV2): string[] {
  const errors: string[] = [];
