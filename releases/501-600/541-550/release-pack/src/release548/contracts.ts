export interface FederationAndTrustBrokerOperations {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_548_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required"] as const;

export function validateFederationAndTrustBrokerOperations(value: FederationAndTrustBrokerOperations): string[] {
  const errors: string[] = [];
