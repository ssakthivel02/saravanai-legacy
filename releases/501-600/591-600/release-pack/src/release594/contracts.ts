export interface ProductAndPlatformRoadmapGovernanceV2 {
  planId: string;
  tenantId: string;
  owner: string;
  objective: string;
...
export const RELEASE_594_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "dependencies_required", "milestones_required", "rollback_or_exit_required"] as const;

export function validateProductAndPlatformRoadmapGovernanceV2(value: ProductAndPlatformRoadmapGovernanceV2): string[] {
  const errors: string[] = [];
