export interface MigrationAndDecommissionFactoryV3 {
  planId: string;
  tenantId: string;
  owner: string;
  objective: string;
...
export const RELEASE_595_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "dependencies_required", "milestones_required", "rollback_or_exit_required", "rehearsal_and_reconciliation_required"] as const;

export function validateMigrationAndDecommissionFactoryV3(value: MigrationAndDecommissionFactoryV3): string[] {
  const errors: string[] = [];
