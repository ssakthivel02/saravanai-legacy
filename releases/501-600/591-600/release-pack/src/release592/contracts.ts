export interface EnterpriseArchitectureRepositoryV3 {
  recordId: string;
  tenantId: string;
  name: string;
  owner: string;
...
export const RELEASE_592_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "provenance_required", "lifecycle_governance_required"] as const;

export function validateEnterpriseArchitectureRepositoryV3(value: EnterpriseArchitectureRepositoryV3): string[] {
  const errors: string[] = [];
