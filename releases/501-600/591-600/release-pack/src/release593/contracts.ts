export interface ContinuousControlMonitoringV2 {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_593_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required"] as const;

export function validateContinuousControlMonitoringV2(value: ContinuousControlMonitoringV2): string[] {
  const errors: string[] = [];
