# Release 599 — Enterprise Platform v5 General Availability Board

    ## Objective

    Make accountable launch decisions using product, security, privacy, operations and support evidence.
