export interface WorkplaceOperationsAssuranceGate {
  gateId: string;
  releaseRange: '551-560';
...
export const RELEASE_560_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "evidence_index_hash_required", "residual_risks_recorded", "no_go_supported", "worker_privacy_required"] as const;

export function validateWorkplaceOperationsAssuranceGate(value: WorkplaceOperationsAssuranceGate): string[] {
  const errors: string[] = [];
