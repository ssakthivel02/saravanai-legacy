export interface WorkplaceChangeAndAdoption {
  planId: string;
  tenantId: string;
  owner: string;
  objective: string;
...
export const RELEASE_559_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "dependencies_required", "milestones_required", "rollback_or_exit_required", "worker_privacy_required"] as const;

export function validateWorkplaceChangeAndAdoption(value: WorkplaceChangeAndAdoption): string[] {
  const errors: string[] = [];
