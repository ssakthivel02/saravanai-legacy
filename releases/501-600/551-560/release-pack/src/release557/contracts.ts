export interface OfficeProcessAnalyticsWithoutSurveillance {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_557_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required", "invasive_surveillance_forbidden"] as const;

export function validateOfficeProcessAnalyticsWithoutSurveillance(value: OfficeProcessAnalyticsWithoutSurveillance): string[] {
  const errors: string[] = [];
