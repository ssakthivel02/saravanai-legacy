export interface MeetingIntelligenceAndConsent {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_553_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required", "recording_consent_required"] as const;

export function validateMeetingIntelligenceAndConsent(value: MeetingIntelligenceAndConsent): string[] {
  const errors: string[] = [];
