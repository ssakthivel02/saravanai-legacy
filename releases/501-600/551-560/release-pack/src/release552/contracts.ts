export interface EmailAndCalendarAutomationSafety {
  executionId: string;
  tenantId: string;
  owner: string;
...
export const RELEASE_552_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "idempotency_required", "kill_switch_required", "production_write_forbidden"] as const;

export function validateEmailAndCalendarAutomationSafety(value: EmailAndCalendarAutomationSafety): string[] {
  const errors: string[] = [];
