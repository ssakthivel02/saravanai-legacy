export interface UnifiedWorkQueueAndPersonalProductivity {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_551_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required"] as const;

export function validateUnifiedWorkQueueAndPersonalProductivity(value: UnifiedWorkQueueAndPersonalProductivity): string[] {
  const errors: string[] = [];
