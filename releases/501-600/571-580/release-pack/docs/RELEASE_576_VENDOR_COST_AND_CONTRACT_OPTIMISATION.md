# Release 576 — Vendor Cost and Contract Optimisation

    ## Objective

    Assess supplier pricing, commitments, utilisation, risk, exit, disputes and savings evidence.
...
- `free_first_cost_control_required`
