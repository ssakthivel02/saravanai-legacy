export interface EconomicRiskAndSensitivityTesting {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_578_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required"] as const;

export function validateEconomicRiskAndSensitivityTesting(value: EconomicRiskAndSensitivityTesting): string[] {
  const errors: string[] = [];
