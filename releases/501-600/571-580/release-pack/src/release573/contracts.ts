export interface FinOpsAllocationAndShowbackV2 {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_573_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required"] as const;

export function validateFinOpsAllocationAndShowbackV2(value: FinOpsAllocationAndShowbackV2): string[] {
  const errors: string[] = [];
