export interface VendorCostAndContractOptimisation {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_576_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required", "free_first_cost_control_required"] as const;

export function validateVendorCostAndContractOptimisation(value: VendorCostAndContractOptimisation): string[] {
  const errors: string[] = [];
