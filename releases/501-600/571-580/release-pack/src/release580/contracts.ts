export interface EnterpriseEconomicsAssuranceGate {
  gateId: string;
  releaseRange: '571-580';
...
export const RELEASE_580_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "evidence_index_hash_required", "residual_risks_recorded", "no_go_supported"] as const;

export function validateEnterpriseEconomicsAssuranceGate(value: EnterpriseEconomicsAssuranceGate): string[] {
  const errors: string[] = [];
