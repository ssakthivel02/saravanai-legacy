export interface BudgetPlanningAndScenarioAnalysis {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_572_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required"] as const;

export function validateBudgetPlanningAndScenarioAnalysis(value: BudgetPlanningAndScenarioAnalysis): string[] {
  const errors: string[] = [];
