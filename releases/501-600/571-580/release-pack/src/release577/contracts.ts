export interface ConsumptionQuotaAndEntitlementPlanning {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_577_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required"] as const;

export function validateConsumptionQuotaAndEntitlementPlanning(value: ConsumptionQuotaAndEntitlementPlanning): string[] {
  const errors: string[] = [];
