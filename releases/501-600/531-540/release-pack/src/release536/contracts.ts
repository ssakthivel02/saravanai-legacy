export interface DataIntegrityAndReconciliationRecovery {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_536_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required"] as const;

export function validateDataIntegrityAndReconciliationRecovery(value: DataIntegrityAndReconciliationRecovery): string[] {
  const errors: string[] = [];
