export interface CyberRecoveryServiceCatalogue {
  recordId: string;
  tenantId: string;
  name: string;
  owner: string;
...
export const RELEASE_531_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "provenance_required", "lifecycle_governance_required"] as const;

export function validateCyberRecoveryServiceCatalogue(value: CyberRecoveryServiceCatalogue): string[] {
  const errors: string[] = [];
