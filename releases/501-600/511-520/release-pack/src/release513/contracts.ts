export interface AudioGenerationAndVoiceSafety {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_513_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required", "voice_consent_required"] as const;

export function validateAudioGenerationAndVoiceSafety(value: AudioGenerationAndVoiceSafety): string[] {
  const errors: string[] = [];
