export interface VideoGenerationAndEditingSafety {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_514_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required", "likeness_and_context_review_required"] as const;

export function validateVideoGenerationAndEditingSafety(value: VideoGenerationAndEditingSafety): string[] {
  const errors: string[] = [];
