export interface ImageGenerationAndEditingGovernance {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_512_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required", "synthetic_media_disclosure_required"] as const;

export function validateImageGenerationAndEditingGovernance(value: ImageGenerationAndEditingGovernance): string[] {
  const errors: string[] = [];
