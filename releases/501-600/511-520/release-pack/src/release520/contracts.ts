export interface MultimodalMediaAssuranceGate {
  gateId: string;
  releaseRange: '511-520';
...
export const RELEASE_520_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "evidence_index_hash_required", "residual_risks_recorded", "no_go_supported"] as const;

export function validateMultimodalMediaAssuranceGate(value: MultimodalMediaAssuranceGate): string[] {
  const errors: string[] = [];
