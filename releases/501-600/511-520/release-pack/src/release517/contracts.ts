export interface RightsLicensingAndConsentManagement {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_517_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required", "rights_and_licence_required"] as const;

export function validateRightsLicensingAndConsentManagement(value: RightsLicensingAndConsentManagement): string[] {
  const errors: string[] = [];
