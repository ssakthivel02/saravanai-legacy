# Release 514 — Video Generation and Editing Safety

    ## Objective

    Govern video synthesis, editing, likeness, sensitive contexts, provenance and publication approval.
...
- `likeness_and_context_review_required`
