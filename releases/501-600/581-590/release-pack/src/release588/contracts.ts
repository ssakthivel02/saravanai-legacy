export interface RegionalLegalAndContentReview {
  planId: string;
  tenantId: string;
  owner: string;
  objective: string;
...
export const RELEASE_588_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "dependencies_required", "milestones_required", "rollback_or_exit_required", "qualified_legal_review_required"] as const;

export function validateRegionalLegalAndContentReview(value: RegionalLegalAndContentReview): string[] {
  const errors: string[] = [];
