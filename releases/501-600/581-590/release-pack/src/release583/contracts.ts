export interface BidirectionalAndComplexScriptSupport {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_583_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required"] as const;

export function validateBidirectionalAndComplexScriptSupport(value: BidirectionalAndComplexScriptSupport): string[] {
  const errors: string[] = [];
