export interface GlobalExperienceQualityAnalytics {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_589_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required"] as const;

export function validateGlobalExperienceQualityAnalytics(value: GlobalExperienceQualityAnalytics): string[] {
  const errors: string[] = [];
