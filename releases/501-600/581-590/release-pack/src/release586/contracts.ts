export interface InclusivePersonalisationAndUserControls {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_586_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required"] as const;

export function validateInclusivePersonalisationAndUserControls(value: InclusivePersonalisationAndUserControls): string[] {
  const errors: string[] = [];
