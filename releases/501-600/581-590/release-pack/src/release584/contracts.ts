export interface AccessibleDesignSystemV2 {
  recordId: string;
  tenantId: string;
  name: string;
  owner: string;
...
export const RELEASE_584_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "provenance_required", "lifecycle_governance_required"] as const;

export function validateAccessibleDesignSystemV2(value: AccessibleDesignSystemV2): string[] {
  const errors: string[] = [];
