export interface LocaleAndMarketReadinessRegistry {
  recordId: string;
  tenantId: string;
  name: string;
  owner: string;
...
export const RELEASE_581_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "provenance_required", "lifecycle_governance_required"] as const;

export function validateLocaleAndMarketReadinessRegistry(value: LocaleAndMarketReadinessRegistry): string[] {
  const errors: string[] = [];
