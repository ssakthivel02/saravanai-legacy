export interface GlobalExperienceAssuranceGate {
  gateId: string;
  releaseRange: '581-590';
...
export const RELEASE_590_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "evidence_index_hash_required", "residual_risks_recorded", "no_go_supported"] as const;

export function validateGlobalExperienceAssuranceGate(value: GlobalExperienceAssuranceGate): string[] {
  const errors: string[] = [];
