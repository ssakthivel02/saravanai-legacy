export interface PartnerFederationAndDelegatedAccess {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_527_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required"] as const;

export function validatePartnerFederationAndDelegatedAccess(value: PartnerFederationAndDelegatedAccess): string[] {
  const errors: string[] = [];
