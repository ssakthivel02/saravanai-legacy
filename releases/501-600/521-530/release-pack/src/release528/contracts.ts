export interface IntegrationObservabilityAndServiceObjectives {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_528_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required"] as const;

export function validateIntegrationObservabilityAndServiceObjectives(value: IntegrationObservabilityAndServiceObjectives): string[] {
  const errors: string[] = [];
