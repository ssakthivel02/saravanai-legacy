export interface APIProductLifecycleV2 {
  recordId: string;
  tenantId: string;
  name: string;
  owner: string;
...
export const RELEASE_521_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "provenance_required", "lifecycle_governance_required", "api_security_review_required"] as const;

export function validateAPIProductLifecycleV2(value: APIProductLifecycleV2): string[] {
  const errors: string[] = [];
