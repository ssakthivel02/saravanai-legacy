export interface APISecurityAndAbuseProtectionV2 {
  policyId: string;
  version: string;
  owner: string;
  ruleIds: string[];
...
export const RELEASE_526_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tests_before_approval", "exception_governance_required", "api_security_review_required"] as const;

export function validateAPISecurityAndAbuseProtectionV2(value: APISecurityAndAbuseProtectionV2): string[] {
  const errors: string[] = [];
