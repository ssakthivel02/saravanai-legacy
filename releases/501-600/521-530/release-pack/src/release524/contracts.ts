export interface ConnectorAndAdapterFramework {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_524_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required"] as const;

export function validateConnectorAndAdapterFramework(value: ConnectorAndAdapterFramework): string[] {
  const errors: string[] = [];
