export interface APIAndIntegrationFabricAssuranceGate {
  gateId: string;
  releaseRange: '521-530';
...
export const RELEASE_530_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "evidence_index_hash_required", "residual_risks_recorded", "no_go_supported", "api_security_review_required"] as const;

export function validateAPIAndIntegrationFabricAssuranceGate(value: APIAndIntegrationFabricAssuranceGate): string[] {
  const errors: string[] = [];
