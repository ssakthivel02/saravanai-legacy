export interface AgentToolProtocolGateway {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_525_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required", "bounded_tool_authority_required"] as const;

export function validateAgentToolProtocolGateway(value: AgentToolProtocolGateway): string[] {
  const errors: string[] = [];
