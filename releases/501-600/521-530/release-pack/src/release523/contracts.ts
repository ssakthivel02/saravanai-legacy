export interface WebhookDeliveryAndReplayGovernance {
  executionId: string;
  tenantId: string;
  owner: string;
...
export const RELEASE_523_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "idempotency_required", "kill_switch_required", "production_write_forbidden", "signature_and_replay_control_required"] as const;

export function validateWebhookDeliveryAndReplayGovernance(value: WebhookDeliveryAndReplayGovernance): string[] {
  const errors: string[] = [];
