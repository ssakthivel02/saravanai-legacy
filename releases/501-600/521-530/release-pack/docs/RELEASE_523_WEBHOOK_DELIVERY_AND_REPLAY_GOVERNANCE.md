# Release 523 — Webhook Delivery and Replay Governance

    ## Objective

    Deliver webhooks with signatures, retries, idempotency, replay limits, evidence and revocation.
...
- `signature_and_replay_control_required`
