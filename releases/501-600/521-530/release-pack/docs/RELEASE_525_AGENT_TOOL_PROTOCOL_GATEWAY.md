# Release 525 — Agent Tool Protocol Gateway

    ## Objective

    Expose bounded tool capabilities through authenticated, tenant-scoped, allowlisted protocol contracts.
...
- `bounded_tool_authority_required`
