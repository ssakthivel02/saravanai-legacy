export interface CrisisAlertingAndNotification {
  executionId: string;
  tenantId: string;
  owner: string;
...
export const RELEASE_562_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "idempotency_required", "kill_switch_required", "production_write_forbidden"] as const;

export function validateCrisisAlertingAndNotification(value: CrisisAlertingAndNotification): string[] {
  const errors: string[] = [];
