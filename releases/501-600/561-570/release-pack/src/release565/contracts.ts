export interface MissingPersonAndFamilyReunificationSafety {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_565_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required"] as const;

export function validateMissingPersonAndFamilyReunificationSafety(value: MissingPersonAndFamilyReunificationSafety): string[] {
  const errors: string[] = [];
