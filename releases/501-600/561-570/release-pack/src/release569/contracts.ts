export interface PublicEventAndCrowdSafetyInformation {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_569_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required"] as const;

export function validatePublicEventAndCrowdSafetyInformation(value: PublicEventAndCrowdSafetyInformation): string[] {
  const errors: string[] = [];
