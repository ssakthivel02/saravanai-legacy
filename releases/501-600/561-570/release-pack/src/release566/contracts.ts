export interface PublicHealthInformationBoundary {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_566_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required", "non_clinical_boundary_required"] as const;

export function validatePublicHealthInformationBoundary(value: PublicHealthInformationBoundary): string[] {
  const errors: string[] = [];
