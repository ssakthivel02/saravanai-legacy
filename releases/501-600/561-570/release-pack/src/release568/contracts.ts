export interface VolunteerAndCommunityCoordination {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_568_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required"] as const;

export function validateVolunteerAndCommunityCoordination(value: VolunteerAndCommunityCoordination): string[] {
  const errors: string[] = [];
