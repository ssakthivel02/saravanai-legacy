export interface PublicSafetyAndHumanitarianAssuranceGate {
  gateId: string;
  releaseRange: '561-570';
...
export const RELEASE_570_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "evidence_index_hash_required", "residual_risks_recorded", "no_go_supported", "vulnerable_person_data_protection"] as const;

export function validatePublicSafetyAndHumanitarianAssuranceGate(value: PublicSafetyAndHumanitarianAssuranceGate): string[] {
  const errors: string[] = [];
