export interface HumanitarianDataProtection {
  profileId: string;
  tenantId: string;
  owner: string;
  policyRefs: string[];
...
export const RELEASE_564_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "tenant_scope_required", "policy_binding_required", "vulnerable_person_data_protection"] as const;

export function validateHumanitarianDataProtection(value: HumanitarianDataProtection): string[] {
  const errors: string[] = [];
