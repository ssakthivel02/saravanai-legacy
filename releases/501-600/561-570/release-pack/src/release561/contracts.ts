export interface EmergencyInformationVerification {
  assessmentId: string;
  tenantId: string;
  subjectId: string;
  owner: string;
...
export const RELEASE_561_CONTROLS = ["owner_accountability_required", "evidence_integrity_required", "methodology_required", "findings_review_required", "source_verification_required"] as const;

export function validateEmergencyInformationVerification(value: EmergencyInformationVerification): string[] {
  const errors: string[] = [];
