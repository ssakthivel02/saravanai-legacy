# Release 570 — Public Safety and Humanitarian Assurance Gate

    ## Objective

    Gate emergency capabilities on verification, privacy, accessibility, safeguarding and continuity.
...
- `no_go_supported`
- `vulnerable_person_data_protection`
