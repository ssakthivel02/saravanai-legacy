...
if (manifest.name !== 'Omni AI Workspace' || manifest.short_name !== 'Omni' || manifest.display !== 'standalone') throw new Error('Invalid Omni PWA manifest');
...
console.log('Validation passed: Omni legacy PWA identity with SakthiAI Release 012-020 governance foundation, Release 011 owner security and free-only routing.');
