...
export const ACCESS_ROUTE_CATALOGUE = Object.freeze([
  ...
  Object.freeze({ id: 'owner-storage-lifecycle', match: exact('/api/v1/platform/storage/lifecycle'), methods: ['GET'], roles: OWNER_ONLY, classification: 'owner-storage-assurance-read', serverMutation: false }),
